...
public class CalendarLocatorObject extends PlatformBase{
	...
	public By ELEMENT_ATTACHMENT_CANCEL_BUTTON = By.xpath("//*[@id='UIAttachFileForm']//*[text()='Cancel']");
	...
	//Popover contain   
	public static By ELEMENT_EVENT_POPOVER_TITLE_ELEMENT = By.xpath("//*[contains(@class,'popover-content')]//*[@contains(@class,'title')]");
	public static By ELEMENT_EVENT_POPOVER_TIME_ELEMENT = By.xpath("//*[contains(@class,'popover-content')]//*[@contains(@class,'time')]");
	public static By ELEMENT_EVENT_POPOVER_DESCRIPTION_ELEMENT = By.xpath("//*[contains(@class,'popover-content')]//*[@contains(@class,'description')]");
	public static By ELEMENT_EVENT_POPOVER_LOCATION_ELEMENT = By.xpath("//*[contains(@class,'popover-content')]//*[@contains(@class,'location')]");

	public static String ELEMENT_EVENT_POPOVER_TITLE_INFO = "//*[contains(@class,'popover-content')]//*[contains(@class,'title')]//*[contains(text(),'$info')]";
	...
	public By ELEMENT_ADD_EDIT_TASK_LOCATION=By.xpath("//*[@id='UITaskForm']//*[@id='place']");
	...
	public By ELEMENT_DISABLE_TASK_ADD_ATTACHMENT = By.xpath("//button[@class='btn disableIcon' and @data-original-title='You cannot attach more than 10 files']");
	...
	public By ELEMENT_SELECT_NO_FILE=By.xpath("//*[@class='uploadButton']/*[@class='noFile' and text()='No file selected']");
	

	//Popover contain   
	public static By ELEMENT_TASK_POPOVER_TITLE_ELEMENT = By.xpath("//*[contains(@class,'popover-content')]//*[@contains(@class,'title')]");
	public static By ELEMENT_TASK_POPOVER_TIME_ELEMENT = By.xpath("//*[contains(@class,'popover-content')]//*[@contains(@class,'time')]");
	public static By ELEMENT_TASK_POPOVER_DESCRIPTION_ELEMENT = By.xpath("//*[contains(@class,'popover-content')]//*[@contains(@class,'description')]");
	public static By ELEMENT_TASK_POPOVER_LOCATION_ELEMENT = By.xpath("//*[contains(@class,'popover-content')]//*[@contains(@class,'location')]");

	public static String ELEMENT_TASK_POPOVER_TITLE_INFO = "//*[contains(@class,'popover-content')]//*[contains(@class,'title')]//*[contains(text(),'$info')]";
	public static String ELEMENT_TASK_POPOVER_TIME_INFO = "//*[contains(@class,'popover-content')]//*[contains(@class,'time')]//*[contains(text(),'$info')]";
