...
public class ContentTemplate extends EcmsBase {
	...
	public final By ELEMENT_HEAD_LAYOUT_UPLOAD_FRAME = By
			.xpath("//iframe[contains(@id,'uploadFrame')]");
	 ...
	 * @param params
	 */
	public void createNewFileForCK(String name, String cont,boolean isDecorated, Object... params) {
		...
		if (isDecorated){
			...
			driver.switchTo().frame(waitForAndGetElement(By.xpath("//*[@class='ECMIframe']")));
 ...
 * @param params
 */
public void editNewContentForCK(String name,String title, String cont, String sum, boolean... params) {
	boolean isDecorated = (boolean) (params.length > 0 ? params[0] : false);
	actBar.goToEditDocument(name);
	info("title:"+title);
 ...
 * @param params
 */
public void editNewWebContentForCK(String name,boolean isDecorated, Object... params) {
	String title = (String)(params.length>0? params[0]:"");
	String cont= (String)(params.length>1? params[1]:"");
	String sum= (String)(params.length>2? params[2]:"");
	String tab1 =(String)(params.length>3? params[3]:"");
...
/**
 * Edit a new Ill. Web content files that has many CKEditor with CKeditor format
 * @param name
 * @param isDecorated
 * @param params
 */
public void editNewIllWebContentForCK(String name,boolean isDecorated, Object... params) {
	String title = (String)(params.length>0? params[0]:"");
	String cont= (String)(params.length>1? params[1]:"");
	String sum= (String)(params.length>2? params[2]:"");
	String tab1 =(String)(params.length>3? params[3]:"");
 ...
 * @param params
 */
public void editNewAccessibleMedia(String name,boolean isDecorated, Object... params) {
	actBar.goToEditDocument(name);
	String title = (String) (params.length > 0 ? params[0] : "");
	String content = (String) (params.length > 1 ? params[1] : "");
	String lang = (String) (params.length > 2 ? params[2] : "");
 ...
 * @param params
 */
public void editNewAnnouncement(String name, String sum,boolean isDecorated,Object... params) {
	actBar.goToEditDocument(name);
	inputFrame(ELEMENT_ANNOUNCEMENT_SUMMARY_FRAME, sum);
	if(isDecorated==true){
		pressGroupKeysUsingRobot(KeyEvent.VK_CONTROL, KeyEvent.VK_A);
 ...
 * @param params
 */
public void editNewHtmlFile(String name,boolean isDecorate, Object... params) {
	String lang = (String) (params.length > 0 ? params[0] : "");
	String content = (String) (params.length > 1 ? params[1] : "");
	info("-- Creating a new HTML File --");
	actBar.goToEditDocument(name);
 ...
 * @param params
 */
public void editNewProductForCK(String name,String sum,String benefits ,String feature,boolean... params) {
	boolean isDecoredSum = (boolean)(params.length>0 ? params[0]:false);
	boolean isDecoredBenefits = (boolean)(params.length>1 ? params[1]:false);
	boolean isDecoredFeature = (boolean)(params.length>2 ? params[2]:false);
