...
public class SourceTextEditor extends WikiLocators {
	...
	public void addSimplePage(String title, String content) {
		...
		if (!content.isEmpty()) {
			...
			for (int i = 0; i < text.length; i++) {
				...
				waitForAndGetElement(ELEMENT_CONTENT_WIKI_INPUT).sendKeys(
						Keys.ENTER);
			}
		}
	}
	...
	public void addSimplePageWithAutoSaveStatus(String title, String content) {
		...
		waitForAndGetElement(ELEMENT_WIKI_PAGE_TOOL_BAR_AUTO_SAVE_TEXT, 31000,
				1);
	 ...
	 * 
	 */
	public void inputDataToPage(String title, String content,
			Boolean isClearTitle, Boolean isClearContent) {
		String[] text;
