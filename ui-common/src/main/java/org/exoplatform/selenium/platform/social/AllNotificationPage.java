...
public class AllNotificationPage extends PlatformBase{

	public final By ELEMENT_NOTIFICATION_POP_UP = By.id("NotificationPopup");
	public final String ELEMENT_USER_AVATAR = "//img[contains(@alt,'${userName}')]";
	...
	public final String ELEMENT_NOTIFICATION_SETTINGS_TITLE = "//*[text()='Notifications Settings']";
	
	//comment
	public final String ELEMENT_COMMENT_ONE_MINUTE = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has commented on your activity.')]/a[@class='user-name text-bold' and contains(text(), '${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_COMMENT_JUST_NOW = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has commented on your activity.')]/a[@class='user-name text-bold' and contains(text(), '${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	public final String ELEMENT_COMMENT_POSITION_ONE_MINUTE = "//li[${position}]//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has commented on your activity.')]/a[@class='user-name text-bold' and contains(text(), '${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_COMMENT_POSITION_JUST_NOW = "//li[${position}]//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has commented on your activity.')]/a[@class='user-name text-bold' and contains(text(), '${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	public final String ELEMENT_COMMENT_2_USERS_ONE_MINUTE = "//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),'and')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_COMMENT_2_USERS_JUST_NOW = "//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),'and')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	public final String ELEMENT_COMMENT_3_USERS_ONE_MINUTE = "//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),',')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_COMMENT_3_USERS_JUST_NOW = "//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),',')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	public final String ELEMENT_COMMENT_2_USERS_POSITION_ONE_MINUTE = "//li[${position}]//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),'and')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_COMMENT_2_USERS_POSITION_JUST_NOW = "//li[${position}]//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),'and')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	public final String ELEMENT_COMMENT_3_USERS_POSITION_ONE_MINUTE = "//li[${position}]//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),',')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_COMMENT_3_USERS_POSITION_JUST_NOW = "//li[${position}]//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),',')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	...
	//Connection
	public final String ELEMENT_CONNECT_NOTIFICATION = "//img[contains(@alt,'${fullName}')]/../..//*[@class='user-name text-bold' and contains(text(),'${fullName}')]/../..//*[@class='status' and contains(text(),'wants to connect with you')]";
	public final String ELEMENT_CONNECT_ACCEPT_BUTTON = ELEMENT_CONNECT_NOTIFICATION + "/..//a[contains(text(),'Accept')]";
	public final String ELEMENT_CONNECT_REFUSE_BUTTON = ELEMENT_CONNECT_NOTIFICATION + "/..//a[contains(text(),'Refuse')]";
	public final String ELEMENT_CONNECTED_SUCCESS_ONE_MINUTE = "//img[contains(@alt,'${fullName}')]/../..//*[@class='status' and contains(text(),'You are connected with')]//*[@class='user-name text-bold' and contains(text(),'${fullName}')]/../..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_CONNECTED_SUCCESS_JUST_NOW = "//img[contains(@alt,'${fullName}')]/../..//*[@class='status' and contains(text(),'You are connected with')]//*[@class='user-name text-bold' and contains(text(),'${fullName}')]/../..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	
	//mention
	public final String ELEMENT_MENTION_ONE_MINUTE = "//img[contains(@alt,'${userName1}')]/../..//*[@class='status' and contains(text(),'has mentioned you.')]/../..//*[@class='content' and contains(text(),'${activity}')]/../..//*[@class='lastUpdatedTime' and text()='${time} minute ago']";
	public final String ELEMENT_MENTION_JUST_NOW = "//img[contains(@alt,'${userName1}')]/../..//*[@class='status' and contains(text(),'has mentioned you.')]/../..//*[@class='content' and contains(text(),'${activity}')]/../..//*[@class='lastUpdatedTime' and text()='Just Now']";
	
	//Post in Activity Stream
	public final String ELEMENT_POST_ACTIVITY_ONE_MINUTE = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has posted on your activity stream.')]/../*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_POST_ACTIVITY_JUST_NOW = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has posted on your activity stream.')]/../*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	public final String ELEMENT_POST_ACTIVITY_SPACE_ONE_MINUTE = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has posted an activity in the')]/..//*[@class='user-name text-bold' and contains(text(),'${userName}')]/..//*[@class='text-bold' and contains(text(),'${space}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_POST_ACTIVITY_SPACE_JUST_NOW = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has posted an activity in the')]/..//*[@class='user-name text-bold' and contains(text(),'${userName}')]/..//*[@class='text-bold' and contains(text(),'${space}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	
	//Space Notification
	public final String ELEMENT_SPACE_INVITATION = "//img[contains(@alt,'${space}')]/../..//*[@class='text-bold' and contains(text(),'${space}')]";
	...
	public final String ELEMENT_SPACE_INVITATION_SUUCESS_ONE_MINUTE = "//img[contains(@alt,'${space}')]/../..//*[@class='status' and contains(text(),'You joined')]/*[@class='text-bold' and contains(text(),'${space}')]/../..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_SPACE_INVITATION_SUUCESS_JUST_NOW = "//img[contains(@alt,'${space}')]/../..//*[@class='status' and contains(text(),'You joined')]/*[@class='text-bold' and contains(text(),'${space}')]/../..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	...
	public final String ELEMENT_REQUEST_JOIN_SPACE_ONE_MINUTE = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has requested access to')]/*[@class='text-bold' and contains(text(),'${space}')]/../..//*[@class='lastUpdatedTime' and contains(text(),'${time] minute ago')]";
	public final String ELEMENT_REQUEST_JOIN_SPACE_JUST_NOW = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'has requested access to')]/*[@class='text-bold' and contains(text(),'${space}')]/../..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	...
	public final String ELEMENT_REQUEST_TO_JOIN_SPACE_SUCCESS_ONE_MINUTE = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'joined')]/*[@class='user-name text-bold' and contains(text(),'${userName}')]/../*[@class='text-bold' and contains(text(),'${space}')]/../..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_REQUEST_TO_JOIN_SPACE_SUCCESS_JUST_NOW = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'joined')]/*[@class='user-name text-bold' and contains(text(),'${userName}')]/../*[@class='text-bold' and contains(text(),'${space}')]/../..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	
	//Like notification
	public final String ELEMENT_LIKE_NOTIFICATION_ONE_MINUTE = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'likes your activity.')]/a[@class='user-name text-bold' and contains(text(), '${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_LIKE_NOTIFICATION_JUST_NOW = "//img[contains(@alt,'${userName}')]/../..//*[@class='status' and contains(text(),'likes your activity.')]/a[@class='user-name text-bold' and contains(text(), '${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	...
	public final String ELEMENT_LIKE_NOTIFICATION_2_USERS_JUST_NOW = "//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),'and')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	public final String ELEMENT_LIKE_NOTIFICATION_2_USERS_ONE_MINUTE = "//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),'and')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content' and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	...
	public final String ELEMENT_LIKE_NOTIFICATION_MORE_THAN_2_USERS_ONE_MINUTE = "//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),',')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content'and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'${time} minute ago')]";
	public final String ELEMENT_LIKE_NOTIFICATION_MORE_THAN_2_USERS_JUST_NOW = "//img[contains(@alt,'${userName2}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName2}')]/../..//*[@class='status' and contains(text(),',')]//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='content'and contains(text(),'${activity}')]/..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	...
	public final String ELEMENT_NEW_USER_NOTIFICATION_ONE_MINUTE = "//img[contains(@alt,'${userName}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='status' and contains(text(),'has joined')]/strong[text()='eXo']/../..//*[@class='lastUpdatedTime' and contains(text(),'${time} minutes ago')]";
	public final String ELEMENT_NEW_USER_NOTIFICATION_JUST_NOW = "//img[contains(@alt,'${userName}')]/../..//a[@class='user-name text-bold' and contains(text(),'${userName}')]/../..//*[@class='status' and contains(text(),'has joined')]/strong[text()='eXo']/../..//*[@class='lastUpdatedTime' and contains(text(),'Just Now')]";
	 ...
	 * @param dr
	 */
	public AllNotificationPage(WebDriver dr){
		this.driver=dr;
	}
	 ...
	 */
	public void checkCommentNotification(String userName, String activity, String time, boolean checkPosition, String position, int userNumber, String userName2){
	 ...
	 * @param moreUser 
	 */
	public void checkLikeNotification(String userName, String activity, String time, boolean checkPosition, String position, int userNumber, String userName2, String moreUser){
	 ...
	 * @param time 
	 */
	public void checkMentionNotification(String userName1, String time, String activity){
	 ...
	 * @param time 
	 */
	public void checkPostActivityNotification(String userName, String activity, String time){
	 ...
	 * @param time 
	 */
	public void goToUserProfileFromIntranetNotificationWithNewUserJoined(String userName1, String time){
		info("Go to User profile from Intranet Notification after new User has joined Intrane");
		myProf = new UserProfilePage(driver);
		if(waitForAndGetElement(ELEMENT_NEW_USER_NOTIFICATION_JUST_NOW.replace("${userName}", userName1)) != null){
	...
	public void gotoActivityViewer(String userName, String activity, String time, String space, boolean twoUser, String userName2, boolean ...params){
		...
		if (twoUser){
			...
			if (commentNotification) {
				...
				if (waitForAndGetElement(ELEMENT_COMMENT_JUST_NOW.replace("${userName}", userName).replace("${activity}", activity)) != null)
			...
			if (mentionNotification) {
				...
				if (waitForAndGetElement(ELEMENT_MENTION_JUST_NOW.replace("${userName1}", userName).replace("${activity}", activity)) != null)
			...
			if (activityPostNotification){
				...
				if(waitForAndGetElement(ELEMENT_POST_ACTIVITY_JUST_NOW.replace("${userName}", userName).replace("${activity}", activity)) != null)
			...
			if (likeNotification){
				...
				if (waitForAndGetElement(ELEMENT_LIKE_NOTIFICATION_JUST_NOW.replace("${userName}", userName).replace("${activity}", activity)) != null)
