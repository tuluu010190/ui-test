...
public class PLF_HomepageGadgets_SuggestionGadget extends Activity{
	...
	public  void test01_Display2PeopleAnd2SpaceSuggestions() {
		...
		String nameSpace1 = "Space1";
		String nameSpace2 = "Space2";
		String nameSpace3 = "Space3";
...
//		mMember.addNewSpace(nameSpace3,"");
		...
		waitForElementNotPresent(hGadget.ELEMENT_VERIFY_USER_SUGGESTIONS.replace("${peopleName}", user1));
	 ...
	 */
	@Test(groups = "pending")
	public  void test02_03_Display2PeopleWithoutConnectionsInCommon() {
		info("Test 2: Display 2 people without connections in common - Case ID:79608");
		...
		info("Test 3: Display 1 People without common connections and 1 People with common connections - Case ID:79609.");
		...
		pConn.acceptInvitation(firstName2+" "+lastName2);
		acc.signOut();
		acc.signIn(username1, password);
		nav.goToHomePage();
		waitForAndGetElement(hGadget.ELEMENT_VERIFY_USER_SUGGESTIONS.replace("${peopleName}", firstName2+" "+lastName2),5000,1,2);
		waitForAndGetElement(hGadget.ELEMENT_VERIFY_USER_SUGGESTIONS.replace("${peopleName}", firstName4+" "+lastName4),5000,1,2);
		waitForElementNotPresent(hGadget.ELEMENT_VERIFY_USER_SUGGESTIONS.replace("${peopleName}", firstName3+" "+lastName3));
	...
	public  void test04_Display2PeopleWithCommonConnections() {
		...
		info("Test 8: Display buttons Connect and revoke for people suggestion - Case ID:79614");
		/*
		- Connect to Intranet
		...
		//mouseOver(hGadget.ELEMENT_VERIFY_USER_SUGGESTIONS.replace("${peopleName}", user3), true);
		waitForAndGetElement(hGadget.ELEMENT_CONNECT_USER_SUGGESTIONS.replace("${peopleName}", user3),5000,1,2);
		waitForAndGetElement(hGadget.ELEMENT_REMOVE_USER_SUGGESTIONS.replace("${peopleName}", user3),5000,1,2);
	...
	public  void test07_Display1SpaceWithoutMembersAreConnectionsAnd1SpaceWithMembersAreConnections() {
		...
		String nameSpace1 = "mySpace";
		String nameSpace2 = "mySpace2";
	...
	public  void test11_RemoveAPeopleSuggestionFromTheGadget() {
		...
		waitForAndGetElement(hGadget.ELEMENT_VERIFY_USER_SUGGESTIONS.replace("${peopleName}", user4),5000,1,2);
//		mouseOver(hGadget.ELEMENT_VERIFY_USER_SUGGESTIONS.replace("${peopleName}", user1), true);
//		Utils.pause(1000);
		waitForAndGetElement(hGadget.ELEMENT_CONNECT_USER_SUGGESTIONS.replace("${peopleName}", user4),5000,1,2);
		waitForAndGetElement(hGadget.ELEMENT_REMOVE_USER_SUGGESTIONS.replace("${peopleName}", user4),5000,1,2);
