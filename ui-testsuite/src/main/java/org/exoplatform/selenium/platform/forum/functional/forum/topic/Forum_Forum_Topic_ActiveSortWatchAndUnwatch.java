...
public class Forum_Forum_Topic_ActiveSortWatchAndUnwatch extends ForumBase{
	...
	public  void test01_CheckSendNotifyWhenAddPostInTopicOrForumOrCategoryThatIsBeingWatched() throws AWTException {
		...
		topic.startTopic(title, description, "", 0, permission, false, false, false);
	 ...
	 */
	@Test
	public  void test02_CheckSendNotifyWhenAddPrivatePostInTopicOrForumOrCategoryThatIsBeingWatched() throws AWTException {
...
*/
		...
		Utils.pause(30000);
		waitForElementNotPresent(By.xpath(ELEMENT_GMAIL_EMAIL.replace("${category}",catNameEdit).replace("${forum}", addForum[0])));
	 ...
	 */
	@Test
	public  void test08_SortTopicByRating() {
