...
public class ECMS_DMS_SE_BasicAction_DragAndDrop extends EcmsBase 
{
	...
	@Test()
	public void test01_DragAndDropInLeft()
	{
		...
		info("Drag and drop a node in the left to a node in the left pane!");
		//goto Site Explorer
		goToSiteExplorer();
	...
	@Test()
	public void test02_DragAndDropLeftToRight()
	{
		...
		info("Drag and drop a node in the left to a node in the right pane!");
		//goto Site Explorer
		goToSiteExplorer();
	...
	public void test03_DragAndDropInRight()
	{
		...
		info("Drag and drop a node in the right to a node in the right pane!");
		//goto Site Explorer
		goToSiteExplorer();
	...
	public void test04_DragAndDropRightToLeft()
	{
		...
		info("Drag and drop a node in the right to a node in the left pane!");
		//goto Site Explorer
		goToSiteExplorer();
