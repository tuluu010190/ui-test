...
public class ECMS_DMS_SE_BasicAction_AddSymlink extends EcmsBase{
	...
	public static final By ELEMENT_SELECT_PATH_DOCUMENTS = By.xpath("//*[@id='UISelectPathPanel']/table/tbody/tr/td/div[contains(text(),'Documents')]/../../td[2]/a");
	...
	@BeforeMethod
	  ...
	  public void test01_AddSymlinkForNode(){
		  ...
		  info("Check add symlink popup is successful");
	  }
	  ...
	  public void test02_AddSymlinkWhenRightClick(){
		  ...
		  assert isElementPresent(ELEMENT_DOCUMENT_SYMLINK):"Add new symlink is not successful";
		  info("Add symlink for documents is successful");
...
//		  assert isElementPresent(CATEGORIES_SYMLINK):"Add symlink for categories is not successful";
//		  waitForElementPresent(CSS_SYMLINK);
//		  assert isElementPresent(CSS_SYMLINK):"Add symlink for css is not successful";
//		  info("Add symlink for categories and symlink is successful");
//		  //delete symlink
...
//		  waitForElementNotPresent(CSS_SYMLINK);
	  ...
	  public void test04_AddSymlinkForRoot(){	
		  ...
		  assert isElementPresent(ELEMENT_LIVE):"Add symlink for documents node is not successful";
		  info("Add symlink for document node is successful");
	  ...
	  public void test05_AddSymlinkForContentFolder(){
		  ...
		  goToNode(ELEMENT_CONTENT_FOLDER);
		  waitForElementPresent(ELEMENT_DOCUMENT_SYMLINK);
		  assert isElementPresent(ELEMENT_DOCUMENT_SYMLINK):"Add symlink for content folder is not successful";
	  ...
	  public void test06_AddSymlinkForDocumentFolder(){
		  ...
		  goToNode(ELEMENT_DOCUMENT_FOLDER);
		  waitForElementPresent(ELEMENT_DOCUMENT_SYMLINK);
		  assert isElementPresent(ELEMENT_DOCUMENT_SYMLINK):"Add symlink for document folder is not successful";
	  ...
	  public void test07_AddSymlinkForArticleDocument(){
		  ...
		  goToNode(ELEMENT_COLLABORATOR);
		  info("Check can not add symlink for article document");
	  ...
	  public void test08_AddSymlinkForFileDocument(){
		  ...
		  waitForElementPresent(ELEMENT_DOCUMENT_SYMLINK);
		  assert isElementPresent(ELEMENT_DOCUMENT_SYMLINK):"Add symlink for file document is not successful";
	  ...
	  public void test09_AddSymlinkForPodcastDocument(){
		  ...
		  assert isElementPresent(ELEMENT_PODCAST_DOCUMENT):"Create new podcast document is not successful";
		  ...
		  checkPreferenceOption("enableStructure");
		  waitForElementPresent(ELEMENT_DOCUMENT_SYMLINK);
		  assert isElementPresent(ELEMENT_DOCUMENT_SYMLINK):"Add symlink for podcast document is not successful";
	  ...
	  public void test10_AddSymlinkForSampleNode(){
		  ...
		  By ELEMENT_SAMPLE = By.xpath("//a[@title='"+DATA_SAMPLE+" "+"']");
		  ...
		  assert isElementPresent(ELEMENT_SAMPLE):"Create new sample node is not successful";
		  info("Create new sample node is successful");
		  
		  //add symlink
		  goToNode(ELEMENT_SAMPLE);
		  goToNode(ELEMENT_COLLABORATOR);
		  info("Check can not add symlink for sample node");
		  addSymlink(ELEMENT_SELECT_PATH_DOCUMENTS,"Documents.lnk");
		  checkAlertWarning("An error occurred while creating the symlink.");
		  click(ELEMENT_CANCEL_BUTTON);
	   ...
	   * add symlink
	   * check add symlink is successful
	   */
	  @Test
	  public void test11_AddSymlinkForFilePlan(){
		  ...
		  goToNode(ELEMENT_FILE_PLAN);
		  waitForElementPresent(ELEMENT_DOCUMENT_SYMLINK);
		  assert isElementPresent(ELEMENT_DOCUMENT_SYMLINK):"Add symlink for file plan is not successful";
	  ...
	  public void test12_AddSymlinkForKofax(){
		  ...
		  assert isElementPresent(ELEMENT_KOFAX):"Create new kofax is not successful";
		  ...
		  goToNode(ELEMENT_KOFAX);
		  waitForElementPresent(ELEMENT_DOCUMENT_SYMLINK);
		  assert isElementPresent(ELEMENT_DOCUMENT_SYMLINK):"Add symlink for kofax is not successful";
		  info("Add symlink for kofax document is successful");
	  ...
	  public void test13_AddSymlinkForUploadedFile(){
		  ...
		  assert isElementPresent(ELEMENT_UPLOAD_FILE):"Create new kofax is not successful";
		  info("Create new kofax is successful");
	  ...
	  public void test14_AddSymlinkForSymlinkNode(){
		  ...
		  waitForElementPresent(ELEMENT_DOCUMENT_SYMLINK);
		  assert isElementPresent(ELEMENT_DOCUMENT_SYMLINK):"Add symlink for content folder is not successful";
		  info("Add symlink for content folder is successful");
		  ...
		  assert isElementPresent(ELEMENT_USER_SYMLINK):"Add symlink for symlink is not successful";
		  info("Add symlink for symlink node is successful");
	   ...
	   * check can not found target node is symlink documents.lnk
	   */
	  @Test
	  public void test15_AddSymlinkForNodeToSymlinkNode(){
		  ...
		  info("Can not select target node is a symlink node");
		  click(ELEMENT_CLOSE);
	  ...
	  public void test16_AddSymlinkWithBlankName(){
		  ...
		  info("Can not add symlink with blank name");
	  }
	  ...
	  public void test17_AddSymlinkWithBlankPathNode(){		  
		  ...
		  info("Can not add symlink with blank path node");
	  }
	  ...
	  public void test18_AddSymlinkWithNameContainsSpecialCharacter(){
		  ...
		  for(int i=0;i< specialCharacters.length; i++){
			  ...
			  addSymlink(ELEMENT_SELECT_PATH_DOCUMENTS, specialCharacters[i]);
			  //check alert
			  checkAlertWarning("An error occurred while creating the symlink.");
			  info("Can not add symlink with name contains qspecial characters");
			  click(ELEMENT_CANCEL_BUTTON);
		  }
	  }
	   ...
	   * check can not add symlink for this node with system workspace
	   */
	  @Test
	  public void test19_CheckDisplayWorkspaceWhenUserHasNotPermission(){
		  ...
		  info("Can not add symlink with user has not permission to view it");
	  ...
	  public void test20_CheckDisplayNodeWhenUserNotHaveViewPermission(){	  
		  ...
		  info("Can not see node when user does not have view permission");
		  click(ELEMENT_CLOSE);
	  ...
	  public void test21_Add2SymlinksHaveSameNameInContentFolder(){
		  ...
		  assert (document.size()==2):"Add 2 symlink is not successful";
		  info("Add 2 symlink same name in content folder is successful");
	  ...
	  public void test22_Add2SymlinksHaveSameNameInDocumentFolder(){
		  ...
		  info("Can not add 2 symlink same name in document folder");
	   ...
	   * check can not add 2 symlinks have samve name in document
	   */
	  @Test
	  public void test23_Add2SymlinksHaveSameNameInDocument(){
		  ...
		  assert isElementPresent(ELEMENT_FILE):"Create new file document is not successful";
		  info("Create new file document is successful");
		  ...
		  //check alert
		  checkAlertWarning("The node name already exists.");
		  info("Can not add 2 symlink same name in file document");
	   ...
	   * upload new file
	   * check can not add 2 symlinks have same name in uploaded file
	   */
	  @Test
	  ...
	  public void test28_AddSymlinkForNodeToLockedNode(){
		  ...
		  assert isElementPresent(ELEMENT_CONTENT_SYMLINK):"Add symlink is not successful";
		  info("Add symlink to locked node is successful");
	  ...
	  public void test30_AddSymlinkForNodeUsingDragDrop(){
		  ...
		  assert isElementPresent(ELEMENT_ARTICLE_DIV):"Add symlink is not successful";
		  info("Add symlink for node is successful");
	  ...
	  public void test34_RenameNodeIsTargetNodeOfSymlink(){
		  ...
		  assert isElementPresent(ELEMENT_CONTENT_FOLDER_2_SYMLINK):"Add symlink for content folder 1 is not successful";
		  info("Add symlink for content folder 1 is successful");
	  ...
	  public void test38_CopySymlinkNodeToOtherNode(){
		  ...
		  addSymlink(ELEMENT_SELECT_PATH_DOCUMENTS,DATA_SYMLINK);
		  waitForElementPresent(ELEMENT_DOCUMENT_SYMLINK);
		  info("Add symlink is successful");
		  ...
		  assert isElementPresent(ELEMENT_SYMLINK_CHILD):"Copy symlink is not successful";
		  info("Copy symlink is successful");
	  ...
	  public void test39_CutSymlinkNodeToOtherNode(){
		  ...
		  assert isElementPresent(ELEMENT_SYMLINK_CHILD_FOLDER2):"Copy symlink is not successful";
		  info("Copy symlink is successful");
