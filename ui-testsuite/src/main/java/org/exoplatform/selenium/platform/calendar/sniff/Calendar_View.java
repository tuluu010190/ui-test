...
public class Calendar_View extends PlatformBase {
	...
	public void setUpBeforeTest() throws Exception{
		...
		event.inputDataEventInQuickForm(titleEventMeeting, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		event.saveQuickAddEvent();
		
		event.goToAddEventFromActionBar();
		event.inputDataEventInQuickForm(titleEventCall, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		event.saveQuickAddEvent();
		
		event.goToAddEventFromActionBar();
		event.inputDataEventInQuickForm(titleEventClient, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		event.saveQuickAddEvent();
		
		event.goToAddEventFromActionBar();
		event.inputDataEventInQuickForm(titleEventHoliday, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		event.saveQuickAddEvent();
		
		event.goToAddEventFromActionBar();
		event.inputDataEventInQuickForm(titleEventAnni, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		event.saveQuickAddEvent();
		
		task.goToAddTaskFromActionBar();
		task.inputDataTaskInQuickForm(titleTaskMeeting, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		task.saveQuickAddTask();
		
		task.goToAddTaskFromActionBar();
		task.inputDataTaskInQuickForm(titleTaskCall, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		task.saveQuickAddTask();
		
		task.goToAddTaskFromActionBar();
		task.inputDataTaskInQuickForm(titleTaskClient, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		task.saveQuickAddTask();
		
		task.goToAddTaskFromActionBar();
		task.inputDataTaskInQuickForm(titleTaskHoliday, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		task.saveQuickAddTask();
		
		task.goToAddTaskFromActionBar();
		task.inputDataTaskInQuickForm(titleTaskAnni, content, getDate(0,defaultFormatDate), getDate(0,defaultFormatDate),true);
		task.saveQuickAddTask();
	...
	public void afterTest(){
		...
		cHome.deleteEventTask( titleEventCur, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleEventNext, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleEventPre, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleEventNextWeek, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleEventPreWeek, selectViewOption.MONTH, selectDayOption.ALLDAY,null);

		cHome.deleteEventTask( titleTaskCur, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleTaskNext, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleTaskPre, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleTaskNextWeek, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleTaskPreWeek, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		
		cHome.deleteEventTask( titleEventMeeting, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleEventCall, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleEventClient, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleEventHoliday, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleEventAnni, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		
		cHome.deleteEventTask( titleTaskMeeting, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleTaskCall, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleTaskClient, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleTaskHoliday, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
		cHome.deleteEventTask( titleTaskAnni, selectViewOption.MONTH, selectDayOption.ALLDAY,null);
	...
	public  void test04_CheckDisplayingAddedTaskeventInMonthView() {
		...
		cHome.goToView(selectViewOption.MONTH);
		click(cHome.ELEMENT_TODAY_ACTION_BAR);
		cHome.verifyIsPresentEventTask(titleEventCur, selectViewOption.MONTH, selectDayOption.ALLDAY);
		cHome.verifyIsPresentEventTask(titleTaskCur, selectViewOption.MONTH, selectDayOption.ALLDAY);
		...
		click(cHome.ELEMENT_NEXT_BUTTON_ANY_VIEW);
		cHome.verifyIsNotPresentEventTask(titleEventCur, selectViewOption.MONTH, selectDayOption.ALLDAY);
		cHome.verifyIsNotPresentEventTask(titleTaskCur, selectViewOption.MONTH, selectDayOption.ALLDAY);
