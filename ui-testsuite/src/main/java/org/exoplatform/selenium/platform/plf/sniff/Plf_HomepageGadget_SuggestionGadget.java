...
import org.testng.annotations.*;
	...
	*/
	public class Plf_HomepageGadget_SuggestionGadget extends Plf_TestConfig{
		...
		*/
		@Test
		public  void test01_NotShowSuggestionsGadget() {
			info("Test 01: Not show suggestions gadget");
			/*Step number: 4
	...
	*/
	@Test
	public  void test02_CheckDisplayOfSuggestionsGadget() {
		info("Test 02: Check display of Suggestions Gadget");
		/*Step Number: 1
	...
	*/
	...
	public  void test03_AcceptASpaceSuggestion(){
		...
		*Expected Outcome: 
		...
		info("Click on Accept button of Space3");
		mouseOver(hp.ELEMENT_SUGGESTION_SPACE.replace("${space}",space3),true);
		waitForAndGetElement(hp.ELEMENT_SUGGESTION_SPACE_CANCEL_BTN.replace("${space}",space3),5000,1,2);
		waitForAndGetElement(hp.ELEMENT_SUGGESTION_SPACE_REQUEST_BTN.replace("{$space}",space3),5000,1,2);
		...
		*Expected Outcome: 
		...
		WebElement elementToClick=waitForAndGetElement(hp.ELEMENT_SUGGESTION_SPACE_REQUEST_BTN.replace("${space}",space3),5000,1,2);
		((JavascriptExecutor)driver).executeScript("arguments[0].click();", elementToClick);
		waitForElementNotPresent(hp.ELEMENT_SUGGESTION_SPACE.replace("${space}",space3));
	...
	public void test04_CancelASpaceConnection(){
		...
		*Expected Outcome: 
		...
		WebElement elementToClick2=waitForAndGetElement(hp.ELEMENT_SUGGESTION_SPACE_CANCEL_BTN.replace("${space}",space2),5000,1,2);
		((JavascriptExecutor)driver).executeScript("arguments[0].click();", elementToClick2);
		waitForElementNotPresent(hp.ELEMENT_SUGGESTION_SPACE.replace("${space}",space2),5000,1,2);
		info("The suggestion of other space is moved up");
	...
	*/
	...
	public  void test05_AcceptAPeopleSuggestion() {
		...
		*Expected Outcome: 
		...
		hp.goToConnections();
		connMg.cancelConnection(userFQA);
 	}
