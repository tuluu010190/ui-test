	...
	*/
	...
	public  void test02_AddAPageWithAddNewLink() {
		...
		*Expected Outcome: 
		...
		wHome.goToAddBlankPage();
		wikiMg.addSimplePageWithRichText(title2,content2);
		wikiMg.insertNewWikiPageLink(title1, label, tooltip, wikiPageLinkTab.My_Recent_Changes);
		wikiMg.saveAddPage();
		Utils.pause(2000);
		wHome.verifyTitleWikiPage(title2);
		arrayPage.add(title2);
	...
	*/
	...
	public  void test04_AddWebPage() {
		...
		*Expected Outcome: 
		...
		wikiMg.insertWebLink(address, label, tooltip);
		wikiMg.saveAddPage();
		Utils.pause(2000);
		wHome.verifyTitleWikiPage(title1);
		arrayPage.add(title1);
	...
	*/
	...
	public  void test05_AddAttachedFileWhenExits() {
		...
		*Expected Outcome: 
		...
		wHome.goToAddBlankPage();
		wikiMg.addSimplePageWithRichText(title1,content1);
		wikiMg.insertAttachedFileLink("TestData/"+attachedFile);
	...
	*/
	...
	public  void test06_AddEmailAddress() {
		...
		*Expected Outcome: 
		...
		wHome.goToAddBlankPage();
		wikiMg.addSimplePageWithRichText(title1,content1);
		wikiMg.insertEmailLink(address, label, tooltip);
		wikiMg.saveAddPage();
		Utils.pause(2000);
		wHome.verifyTitleWikiPage(title1);
		arrayPage.add(title1);
	...
	*/
	...
	public  void test08_AttachImageInList() {
		...
		*Expected Outcome: 
		...
		wHome.goToAddBlankPage();
		wikiMg.addSimplePageWithRichText(title,content);
		wikiMg.insertImage("TestData/"+attachedFile);
