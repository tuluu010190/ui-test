...
public class ECMS_DMS_SE_BasicAction_Edit extends EcmsBase {
	...
	By ELEMENT_DRIVE_SITE_MANAGE= By.xpath("//a[@title='Sites Management']");
	...
	public void test03_EditDocumentWithSaveButton() {
		...
		//choose the site management drive, and create an article
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test05_EditDocumentWithSaveAndCloseButtons() {
		...
		info("Edit document by clicking on the Save and Close buttons");
		//choose the site management drive, and create an article
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test06_EditNameOfArticle() {
		...
		info("Edit the name of an article");
		...
		// check whether to edit the "Name" field
		try{
	...
	public void test07_EditTitleOfArticle() {
		...
		info("Edit the title of an article");
	...
	//edit the summary of an article
	@Test
	public void test08_EditSummaryOfArticle() {
		...
		info("Edit the summary of an article");
	...
	public void test09_EditContentOfArticle() {
		...
		info("Edit the content of an article");
	...
	//edit the summary of an article in edit mode
	@Test
	...
	//edit the content of an article in edit mode
	@Test
	...
	//edit the name of a file document in edit mode
	@Test
	public void test12_EditNameOfFileDocument() {
		...
		info("Edit the name of a file");
		
		//choose the site management drive, and create a file document
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test14_EditNameOfPodcast(){	
		...
		info("Edit the name of a podcast");
		
		//choose the site management drive, and create a podcast
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test15_EditTitleOfPodcast(){	
		...
		//choose the site management drive, and create a podcast document	
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test20_EditNameOfSampleNode(){	
		...
		info("Edit the name of a sample node");
		
		//choose the site management drive, and create a sample node
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test21_EditTitleOfSampleNode(){	
		...
		//choose the site management drive, and create a sample node document	
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	//Edit content of sample node document inline
	@Test
	...
	public void test27_EditNameOfFileDocument(){	
		...
		info("Edit the name of a file document");
	...
	public void test28_EditNameOfKofaxDocument(){	
		...
		info("Edit the name of a kofax document");
		
		//choose the site management drive, and create a kofax document
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test29_EditUploadedFile(){	
		...
		//choose the site management drive, and create a uploaded file
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
	...
	public void test30_EditLockedDocument(){	
		...
		//choose the site management drive, and create a locked document
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test32_EditDocumentInLockedDocument(){	
		...
		//check expected: can edit a podcast, and cannot modify the 'name' field
	...
	public void test33_EditCheckedInDocument(){	
		...
		//choose the site management drive, and create an article document
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
	...
	public void test34_EditDocumentInCheckedInDocument(){	
		...
		// Check whether to edit the child
		waitForElementPresent(ELEMENT_LINK_EDIT);
		checkOutNode(bDocument);
		deleteDocument(bDocument);
	}
	...
	public void test35_EditDocumentInCheckedInDocument(){	
		...
		// Check whether to edit the article
		goToSiteExplorer();
		goToNode(bDocument);
		waitForElementNotPresent(ELEMENT_LINK_EDIT);
		logoutEcms();
	...
	public void test36_EditFreeLayoutContent(){	
		...
		//choose the site management drive, and create a free layout content	
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToAddNewContent();
		...
		waitForElementPresent(bDocument);
		//edit and delete sample node
		editFreeLayoutContent(DATA_FREE_TITLE_36, DATA_FREE_TITLE_36_EDIT, DATA_FREE_TITLE_36_EDIT, DATA_UPLOAD_IMG_2, DATA_FREE_TITLE_36_EDIT, DATA_FREE_TITLE_36_EDIT, DATA_FREE_TITLE_36_EDIT);
		deleteDocument(bDocEdit);
	}

	//Edit a free layout content inline
	@Test
	public void test37_EditFreeLayoutContentInline(){	
		...
		waitForElementPresent(bDocument);
		//edit and delete sample node
		editFreeLayoutContentInline(ELEMENT_FREE_CONT_INLINE,ELEMENT_FREE_CONT_INPUT,DATA_FREE_TITLE_37_EDIT,ELEMENT_FREE_CONT_ACCEPT);
	...
	public void test38_EditPictureOnHeadWebLayout(){	
		...
		//choose the site management drive, and create a picture on head web layout 	
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
		goToNodeByPath("acme/web contents");
		goToAddNewContent();
	...
	public void test39_EditPictureOnHeadWebLayout(){	
		...
		//choose the site management drive, and create a css file 	
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
	...
	public void test40_EditJsFile(){	
		...
		//choose the site management drive, and create a js file 	
		chooseDrive(ELEMENT_DRIVE_SITE_MANAGE);
