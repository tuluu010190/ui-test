...
public class Wiki_SpaceSwitcher extends WikiBase{
	 ...
	 * Done with OSs and browsers : 
	 * Generated by chinhdtt at 2014/05/12 13:45:02
	 * Issue: https://jira.exoplatform.org/browse/COMMONS-324. This issue was fixed
	 */
	@Test
	public  void test16_SpaceSwitcherShouldNotDisplayMoreThan10LastestBrowsedSpaces() {
		...
		//waitForElementNotPresent(By.xpath(ELEMENT_SPACE_SWITCHER_INDEX.replace("${index}","11").replace("${spaceName}", space2)));		
