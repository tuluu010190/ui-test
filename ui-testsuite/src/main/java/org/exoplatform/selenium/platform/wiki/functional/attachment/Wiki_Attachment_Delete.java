...
public class Wiki_Attachment_Delete extends BasicAction{
	 ...
	 */
	@Test
	public  void test01_DeleteAnAttachmentInViewMode() {
		info("Test 1: Delete an attachment in View mode");
	 ...
	 */
	@Test
	public  void test02_DeleteAnAttachmentInEditMode() {
		info("Test 2: Delete an attachment in Edit mode");
		String number=getRandomNumber();
		String DATA_WIKI_PAGE_NAME="wiki"+number;
		String DATA_WIKI_PAGE_CONTENT="content"+number;
		String ATTACHMENT_NAME1="KS_Wiki_Attachment_pdffile.pdf";
		 ...
		 *Expected Outcome: 
			...
			- The number of attachments at Info bar is updated*/ 
		//deleteAnAttachment(ATTACHMENT_NAME1);
		waitForAndGetElement(ELEMENT_REMOVE_ATTACHMENT.replace("{$file}", ATTACHMENT_NAME1)).click();
