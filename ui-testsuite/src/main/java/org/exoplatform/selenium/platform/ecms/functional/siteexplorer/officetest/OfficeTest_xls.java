...
import org.testng.annotations.*;
	...
	*
	*/
	public class OfficeTest_xls extends PlatformBase{
	...
	*<li> Test Case Name: Actions on activity of a .xls file at home page.</li>
	*<li> Pre-Condition: 
	*A. Upload .xlsx file from your local machine with some pages or "xls-sample.xls" in .xls folder (Attachments tab)
	...
	*/
	@Test
	public  void test01_ActionsOnActivityOfA_xlsFileAtHomePage() {
		info("Test 1: Actions on activity of a .xls file at home page");
		
		String fileName="xls-example.xls";
		...
		*Expected Outcome: 
			An activity for this .xls file is shown with:
		...
		waitForAndGetElement(hp.ELEMENT_FILE_SIZE.replace("@{fileName}",fileName).replace("${size}", "19"),2000,1);
		info("Verify actions");
	...
	*<li> Test Case Name: Download a .xls file.</li>
	*<li> Pre-Condition: 
	*A. a .xls file exists in SEB. 
	...
	*/
	@Test(groups="pending")
	public  void test03_DownloadA_xlsFile()  {
		info("Test 3: Download a .xls file");
		String fileName="xls-example-2.xls";
		...
		checkFileExisted(fileName);
		/*Step Number: 1
		*Step Name: Open .xls file
		*Step Description: 
			- Click title of .xls file
		*Input Data: 
			
		*Expected Outcome: 
			Content of .xls file is well displayed.*/
		...
		*Expected Outcome: 
			.xls file is saved successfully with right format and possible to open by office in local machine*/ 
		info("Clear data");
	...
	*<li> Test Case Name: Edit a .xls file via webdav.</li>
	*<li> Pre-Condition: A.Upload .xls file from your local machine with some pages orin 
	*.xls folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	...
	*/
	@Test(groups="pending")
	public  void test05_EditA_xlsFileViaWebdav() {
		info("Test 5: Edit a .xls file via webdav");
		/*Step Number: 1
		*Step Name: Step 1: Edit the file via webdav
		*Step Description: 
			- Go to folder which has .xls file
	...
	*<li> Test Case Name: Remote edition of a .xls file.</li>
	*<li> Pre-Condition: A. Upload .xls file from your local machine with some pages 
	*or "xls-sample.xls" in .xls folder (Attachments tab)B. 
	...
	*/
	@Test(groups="pending")
	public  void test06_RemoteEditionOfA_xlsFile() {
		info("Test 6: Remote edition of a .xls file");
		String fileName="xls-example-4.xls";
		...
		*Expected Outcome: 
		...
		cTemplate.goToNode(fileName);
		/*Step number: 2
		*Step Name: Edit .xls file
		*Step Description: 
			- Right click on .xls file then select [Download and allow Edition]
			- Select [Open]
		*Input Data: 
	...
	*<li> Test Case Name: Save a .xls file as PDF file.</li>
	*<li> Pre-Condition: 
	*A. Upload .xls file from your local machine with some pages or "xls
	-sample.xls" in .xls folder(Attachments tab)
	...
	*/
	@Test(groups="pending")
	public  void test07_SaveA_xlsFileAsPDFFile() {
		info("Test 7: Save a .xls file as PDF file");
		String fileName="xls-example-4.xls";
	...
	*<li> Test Case Name: Search a .xls file (based on keyword).</li>
	*<li> Pre-Condition: - Upload .xls file from your local machine with some pages or "xls
	-sample.xls" in .xls folder (Attachments tab)</li>
	*<li> Post-Condition: </li>
	*<li> Done with OSs and browsers : </li>
	*/
	@Test
	public  void test08_SearchA_xlsFile_basedOnKeyword_() {
		info("Test 8: Search a .xls file (based on keyword)");
		String fileName="xls-example-3.xls";
		String searchName="xls-example";
		...
		*Step Description: 
			...
			- Input keyword(s) issued from xls
			-sample.xls in order to search for this file (words of the document, title..etc)
			- Type enter
		*Input Data: 
			
		*Expected Outcome: 
			The file xls
			-sample.xls is found and listed in the results*/
	...
	*<li> Test Case Name: Upload a .xls file from action bar.</li>
	*<li> Pre-Condition: Take .xls file from your local machine with some pages or "xls
	-sample.xls" in .xls folder(Attachments tab)</li>
	PENDING: THIS CASE IS CHECKED IN PREVIOUS CASES. THE CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test09_UploadA_xlsFileFromActionBar() {
		info("Test 9: Upload a .xls file from action bar");
		String fileName="xls-example-3.xls";
	...
	*<li> Test Case Name: Upload a .xls file via WEBDAV.</li>
	*<li> Pre-Condition: A. Take all .xls files from your local machine with some pages orin .xls folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	- Click on File folder and press Ctrl+L
	- Paste the link: dav://[YOUR
	-IP
	-ADDRESS
	...
	*/
	@Test(groups="pending")
	public  void test10_UploadA_xlsFileViaWEBDAV() {
		info("Test 10 Upload a .xls file via WEBDAV");
		/*Step Number: 1
		*Step Name: Upload .xls file
		*Step Description: 
			- Copy a .xls file toWEBDAV
		*Input Data: 
	...
	*<li> Test Case Name: Upload a .xls file when drap and drop from local machine.</li>
	*<li> Pre-Condition: A. Take all .xls files from your local machine with some pages or 
	*"xls-sample.xls" in .xls folder (Attachments tab)B. Repeat steps for small and big files</li>
	*Pending : impossible to drag and drop from local machine
	*/
	@Test(groups="pending")
	public  void test11_UploadA_xlsFileWhenDrapAndDropFromLocalMachine() {
		info("Test 11 Upload a .xls file when drap and drop from local machine");
		/*Step Number: 1
		*Step Name: Upload .xls file
		*Step Description: 
			- Log in
			...
			- Choose a driveOr
			- Go to Intranet/Documents
			- Drag & Drop a .xls file from local machine to Site Explorer
		*Input Data: 
	...
	*<li> Test Case Name: Upload a .xls file when Right click on main pane.</li>
	*<li> Pre-Condition: Take .xls file from your local machine with some pages or 
	*"xls-sample.xls" in Functional > ECMS > Sites explorer > Office Test (Attachments tab)</li>
	*/
	@Test
	public  void test12_UploadA_xlsFileWhenRightClickOnMainPane() {
		info("Test 12 Upload a .xls file when Right click on main pane");
		String fileName="xls-example-4.xls";
	...
	*<li> Test Case Name: View a .xls file in Site Explorer.</li>
	*<li> Pre-Condition: A. Take .xls file from your local machine with some pages or "xls
	-sample.xls" in .xls folder (Attachments tab)B. Edit "exo.preoperties" file:1. Redirect to the directory: $PLATFORM_TOMCAT_HOME/gatein/conf/exo.properties (in Tomcat) or $PLATFORM_JBOSS_HOME/standalone/configuration/gatein/exo.properties (in Jboss)2. Find "JOD Converter (Documents preview)" section and delete "#" marks on the start of lines as:+exo.jodconverter.enable=false+exo.jodconverter.portnumbers=2002+exo.jodconverter.officehome=/usr/lib/libreoffice+exo.jodconverter.taskqueuetimeout=30000+exo.jodconverter.taskexecutiontimeout=120000+exo.jodconverter.maxtasksperprocess=200+exo.jodconverter.retrytimeout=1200003. After deleted all "#" marks of above lines, find "exo.jodconverter.enable" parameter and change "fasle" to "true" value.4. Find "exo.jodconverter.officehome" parameter. If on your computer installed libreoffice, keep this value. But if on your computer installed openoffice 4, change the value from "/usr/lib/libreoffice" to "/opt/openoffice4" on linux or "c:programfilesx86Openoffice4" on Windows or "c:programfilesx86Libreoffice4" on Windows5. Restart server</li>
	PENDING: THIS CASE IS CHECKED IN DOCUMENT PREVIEW AND OPEN IN OFFICE. SO, THIS CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test13_ViewA_xlsFileInSiteExplorer() {
		info("Test 13 View a .xls file in Site Explorer");
		String fileName="xls-example-4.xls";
		...
		*Step Description: 
			- Log in
			- Go to Aministration/Content/ Sites Explorer
			- Upload a .xls file to Site Explorer
		*Input Data: 
		...
		*Expected Outcome: 
			Content of .xls file is well displayed with
			- File Name
			- Download icon
			- A toolbar with + paginator,+ zoom icon and preview ratio, + Rotate left & right icon+ View info icon +Save as PDF file*/ 
		info("Clear data");
	...
	*<li> Test Case Name: Delete a .xls file.</li>
	*/
	@Test
	public  void test02_Delete_xlsfile() {
		info("Test 2: Delete a .xls file");
		String fileName="xls-example-1.xls";
		info("Pre conditions");
		navToolBar.goToSiteExplorer();
		ecms.uploadFile("TestData/"+fileName);
	...
	*<li> Test Case Name: Edit a .xls file.</li>
	*
	*/
	@Test
	public void test04_Edit_xlsfile(){
		info("Test 4: Edit a .xls file");
		String fileName="xls-example-2.xls";
