...
public class ECMS_DMS_SE_ADMIN_Export extends EcmsBase {
	...
	{
		By ELEMENT_SITE_MNG = By.xpath("//div[@title='Sites Management']");
		goToSiteExplorer();
		
		debug("Select root path");
		goToNode(ELEMENT_SITE_MNG);
	 ...
	 */
	@Test
	public void test02_ExportANodeIsFolder () {
	 ...
	 */
	@Test
	public void test03_ExportNodeIsDocument () {
		By ELEMENT_ACME_NODE = By.xpath("//a[@title='acme ']");
	 ...
	 */
	@Test
	public void test04_ExportNodeIsUploadedFile () {
	 ...
	 */
	@Test
	public void test05_ExportANodeWhenForMatIsDocumentView () {
		By ELEMENT_ACME_NODE = By.xpath("//a[@title='acme ']");
