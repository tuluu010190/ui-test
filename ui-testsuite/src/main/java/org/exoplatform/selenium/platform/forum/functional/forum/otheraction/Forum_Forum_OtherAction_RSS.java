...
public class Forum_Forum_OtherAction_RSS extends ForumBase{
	 ...
	 */
	@Test
	public  void test06_GetRSSOfATopicWhichContainsPrivatePost() {
		info("Test 6: Get RSS of a topic which contains Private post");
		String category = "Category 72975";
		String descTopic = "Test 6 description";
		String forum = "Test 6 new forum";
		String topic=  "Test 6 new topic";
		String post="Test 6 new Post";
		String postMessage="Test 6 new message";
	...
	public  void test07_GetRSSOfACensoredPost() {
		...
		String censorPostMary = "censor post Mary";
		...
		info("User2 create a Censored post");
		acc.userSignIn(userType.PUBLISHER);
		goToForums();
		click(By.linkText(catName));
		...
		click(By.linkText(tpName));
		info("Add a post");
		type(fmPost.ELEMENT_POST_QUICK_MESSAGE, censorPostMary, true);
		click(fmPost.ELEMENT_POST_QUICK_BUTTON);
		alert.acceptAlert();
		...
		- Topic Feeds show: title (Title of the topic), description (content of the topic's initial post), 
		  link (permlink to the topic), pub date (creation date of the topic)		*/ 
		acc.userSignIn(userType.ADMIN);
		goToForums();
		click(By.linkText(catName));
		click(By.linkText(fmName));
		...
		Assert.assertEquals(waitForAndGetElement(ELEMENT_FEED_CONTENT).getText().contains(censorPost), true);
		...
		Assert.assertEquals(waitForAndGetElement(ELEMENT_FEED_CONTENT).getText().contains(censorPostMary), false);
	 ...
	 */
	@Test
	public  void test08_GetRSSOfACategoryAfterMoveForum() {
		info("Test 8: Get RSS of a category after move forum");
