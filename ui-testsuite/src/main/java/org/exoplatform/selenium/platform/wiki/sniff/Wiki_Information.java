...
public class Wiki_Information extends Wiki_TestConfig {
	...
	public  void test03_ViewPageInfo() {
		...
		wHome.goToAddBlankPage();
		rtMode.addSimplePage(child1,child1);
		wikiMg.saveAddPage();
		...
		wHome.goToAddBlankPage();
		rtMode.addSimplePage(child2,child2);
		wikiMg.saveAddPage();
