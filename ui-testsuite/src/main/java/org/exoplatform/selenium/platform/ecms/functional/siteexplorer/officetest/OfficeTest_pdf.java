...
import org.testng.annotations.*;
	...
	*
	*/
	public class OfficeTest_pdf extends PlatformBase{
	...
	/**
	*<li> Case ID:119285.</li>
	*<li> Test Case Name: Actions on activity of a .pdf file at home page.</li>
	*<li> Pre-Condition: 
	*A. Upload .pdf file from your local machine with some pages or "pdf-sample.pdf" in .pdf folder (Attachments tab)
	...
	*/
	@Test
	public  void test01_ActionsOnActivityOfA_PdfFileAtHomePage() {
		info("Test 1: Actions on activity of a .pdf file at home page");
		
		String fileName="pdf-example.pdf";
		...
		*Expected Outcome: 
			An activity for this .pdf file is shown with:
		...
		waitForAndGetElement(hp.ELEMENT_FILE_SIZE.replace("@{fileName}",fileName).replace("${size}", "47"),2000,1);
		info("Verify actions");
	...
	/**
	*<li> Case ID:120042.</li>
	*<li> Test Case Name: Download a .pdf file.</li>
	*<li> Pre-Condition: 
	*A. a .pdf file exists in SEB. 
	...
	*/
	@Test(groups="pending")
	public  void test03_DownloadA_PdfFile()  {
		info("Test 3: Download a .pdf file");
		String fileName="pdf-example-2.pdf";
		...
		checkFileExisted(fileName);
		/*Step Number: 1
		*Step Name: Open .pdf file
		*Step Description: 
			- Click title of .pdf file
		*Input Data: 
			
		*Expected Outcome: 
			Content of .pdf file is well displayed.*/
		...
		*Expected Outcome: 
			.pdf file is saved successfully with right format and possible to open by office in local machine*/ 
		info("Clear data");
	...
	/**
	*<li> Case ID:120041.</li>
	*<li> Test Case Name: Edit a .pdf file via webdav.</li>
	*<li> Pre-Condition: A.Upload .pdf file from your local machine with some pages orin 
	*.pdf folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	...
	*/
	@Test(groups="pending")
	public  void test05_EditA_PdfFileViaWebdav() {
		info("Test 5: Edit a .pdf file via webdav");
		/*Step Number: 1
		*Step Name: Step 1: Edit the file via webdav
		*Step Description: 
			- Go to folder which has .pdf file
	...
	/**
	*<li> Case ID:120043.</li>
	*<li> Test Case Name: Remote edition of a .pdf file.</li>
	*<li> Pre-Condition: A. Upload .pdf file from your local machine with some pages 
	*or "pdf-sample.pdf" in .pdf folder (Attachments tab)B. 
	...
	*/
	@Test(groups="pending")
	public  void test06_RemoteEditionOfA_PdfFile() {
		info("Test 6: Remote edition of a .pdf file");
		String fileName="pdf-example-4.pdf";
		...
		*Expected Outcome: 
		...
		cTemplate.goToNode(fileName);
		/*Step number: 2
		*Step Name: Edit .pdf file
		*Step Description: 
			- Right click on .pdf file then select [Download and allow Edition]
			- Select [Open]
		*Input Data: 
	...
	/**
	*<li> Case ID:120045.</li>
	*<li> Test Case Name: Save a .pdf file as PDF file.</li>
	*<li> Pre-Condition: 
	*A. Upload .pdf file from your local machine with some pages or "pdf
	-sample.pdf" in .pdf folder(Attachments tab)
	...
	*/
	@Test(groups="pending")
	public  void test07_SaveA_PdfFileAsPDFFile() {
		info("Test 7: Save a .pdf file as PDF file");
		String fileName="pdf-example-4.pdf";
	...
	/**
	*<li> Case ID:120046.</li>
	*<li> Test Case Name: Search a .pdf file (based on keyword).</li>
	*<li> Pre-Condition: - Upload .pdf file from your local machine with some pages or "pdf
	-sample.pdf" in .pdf folder (Attachments tab)</li>
	*<li> Post-Condition: </li>
	*<li> Done with OSs and browsers : </li>
	*/
	@Test
	public  void test08_SearchA_PdfFile_basedOnKeyword_() {
		info("Test 8: Search a .pdf file (based on keyword)");
		String fileName="pdf-example-3.pdf";
		String searchName="pdf-example";
		...
		*Step Description: 
			...
			- Input keyword(s) issued from pdf
			-sample.pdf in order to search for this file (words of the document, title..etc)
			- Type enter
		*Input Data: 
			
		*Expected Outcome: 
			The file pdf
			-sample.pdf is found and listed in the results*/
	...
	/**
	*<li> Case ID:120048.</li>
	*<li> Test Case Name: Upload a .pdf file from action bar.</li>
	*<li> Pre-Condition: Take .pdf file from your local machine with some pages or "pdf
	-sample.pdf" in .pdf folder(Attachments tab)</li>
	PENDING: THIS CASE IS CHECKED IN PREVIOUS CASES. THE CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test09_UploadA_PdfFileFromActionBar() {
		info("Test 9: Upload a .pdf file from action bar");
		String fileName="pdf-example-3.pdf";
	...
	/**
	*<li> Case ID:120049.</li>
	*<li> Test Case Name: Upload a .pdf file via WEBDAV.</li>
	*<li> Pre-Condition: A. Take all .pdf files from your local machine with some pages orin .pdf folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	- Click on File folder and press Ctrl+L
	- Paste the link: dav://[YOUR
	-IP
	-ADDRESS
	...
	*/
	@Test(groups="pending")
	public  void test10_UploadA_PdfFileViaWEBDAV() {
		info("Test 10 Upload a .pdf file via WEBDAV");
		/*Step Number: 1
		*Step Name: Upload .pdf file
		*Step Description: 
			- Copy a .pdf file toWEBDAV
		*Input Data: 
	...
	/**
	*<li> Case ID:120047.</li>
	*<li> Test Case Name: Upload a .pdf file when drap and drop from local machine.</li>
	*<li> Pre-Condition: A. Take all .pdf files from your local machine with some pages or 
	*"pdf-sample.pdf" in .pdf folder (Attachments tab)B. Repeat steps for small and big files</li>
	*Pending : impossible to drag and drop from local machine
	*/
	@Test(groups="pending")
	public  void test11_UploadA_PdfFileWhenDrapAndDropFromLocalMachine() {
		info("Test 11 Upload a .pdf file when drap and drop from local machine");
		/*Step Number: 1
		*Step Name: Upload .pdf file
		*Step Description: 
			- Log in
			...
			- Choose a driveOr
			- Go to Intranet/Documents
			- Drag & Drop a .pdf file from local machine to Site Explorer
		*Input Data: 
	...
	/**
	*<li> Case ID:120050.</li>
	*<li> Test Case Name: Upload a .pdf file when Right click on main pane.</li>
	*<li> Pre-Condition: Take .pdf file from your local machine with some pages or 
	*"pdf-sample.pdf" in Functional > ECMS > Sites explorer > Office Test (Attachments tab)</li>
	*/
	@Test
	public  void test12_UploadA_PdfFileWhenRightClickOnMainPane() {
		info("Test 12 Upload a .pdf file when Right click on main pane");
		String fileName="pdf-example-4.pdf";
	...
	/**
	*<li> Case ID:120040.</li>
	*<li> Test Case Name: View a .pdf file in Site Explorer.</li>
	*<li> Pre-Condition: A. Take .pdf file from your local machine with some pages or "pdf
	-sample.pdf" in .pdf folder (Attachments tab)B. Edit "exo.preoperties" file:1. Redirect to the directory: $PLATFORM_TOMCAT_HOME/gatein/conf/exo.properties (in Tomcat) or $PLATFORM_JBOSS_HOME/standalone/configuration/gatein/exo.properties (in Jboss)2. Find "JOD Converter (Documents preview)" section and delete "#" marks on the start of lines as:+exo.jodconverter.enable=false+exo.jodconverter.portnumbers=2002+exo.jodconverter.officehome=/usr/lib/libreoffice+exo.jodconverter.taskqueuetimeout=30000+exo.jodconverter.taskexecutiontimeout=120000+exo.jodconverter.maxtasksperprocess=200+exo.jodconverter.retrytimeout=1200003. After deleted all "#" marks of above lines, find "exo.jodconverter.enable" parameter and change "fasle" to "true" value.4. Find "exo.jodconverter.officehome" parameter. If on your computer installed libreoffice, keep this value. But if on your computer installed openoffice 4, change the value from "/usr/lib/libreoffice" to "/opt/openoffice4" on linux or "c:programfilesx86Openoffice4" on Windows or "c:programfilesx86Libreoffice4" on Windows5. Restart server</li>
	PENDING: THIS CASE IS CHECKED IN DOCUMENT PREVIEW AND OPEN IN OFFICE. SO, THIS CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test13_ViewA_PdfFileInSiteExplorer() {
		info("Test 13 View a .pdf file in Site Explorer");
		String fileName="pdf-example-4.pdf";
		...
		*Step Description: 
			- Log in
			- Go to Aministration/Content/ Sites Explorer
			- Upload a .pdf file to Site Explorer
		*Input Data: 
		...
		*Expected Outcome: 
			Content of .pdf file is well displayed with
			- File Name
			- Download icon
			- A toolbar with + paginator,+ zoom icon and preview ratio, + Rotate left & right icon+ View info icon +Save as PDF file*/ 
		info("Clear data");
	...
	/**
	*<li> Case ID:120044.</li>
	*<li> Test Case Name: Delete a .pdf file.</li>
	*/
	@Test
	public  void test02_Delete_Pdffile() {
		info("Test 2: Delete a .pdf file");
		String fileName="pdf-example-1.pdf";
		info("Pre conditions");
		navToolBar.goToSiteExplorer();
		ecms.uploadFile("TestData/"+fileName);
	...
	/**
	*<li> Case ID:120039.</li>
	*<li> Test Case Name: Edit a .pdf file.</li>
	*
	*/
	@Test
	public void test04_Edit_Pdffile(){
		info("Test 4: Edit a .pdf file");
		String fileName="pdf-example-2.pdf";
