 ...
 */
public class KS_Wiki_Version_View extends Wiki{
	...
	public void test01_ViewContentOfCurrentVersion(){
		...
		editWikiPage(dataInfo[2], dataInfo[3], 0, false);

		editWikiPage(dataInfo[4], dataInfo[5], 0, false);
	...
	public void test01_ViewChangeOfPage(){
		...
		captureScreen("FNC_KS_WIKI_VERSION_VIEW_CHANGE_01_1");

		changeCompareVersions("1", "2");

		captureScreen("FNC_KS_WIKI_VERSION_VIEW_CHANGE_01_2");
	...
	public void test01_ViewLinkOfRevisions(){
		...
		captureScreen("FNC_KS_WIKI_VERSION_VIEW_LINK_01");
	...
	public void test02_ViewLinkOfRevisionsWhenEditPageContentByAnotherUser(){
		...
		goToWikiPage(userType.PUBLISHER, dataInfo[2]);
		...
		waitForElementPresent(ELEMENT_RESTORE_LINK.replace("{$version}","3"));
