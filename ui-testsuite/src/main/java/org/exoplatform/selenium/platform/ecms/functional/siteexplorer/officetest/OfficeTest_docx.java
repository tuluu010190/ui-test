...
import org.testng.annotations.*;
	...
	*
	*/
	public class OfficeTest_docx extends PlatformBase{
	...
	/**
	*<li> Case ID:119281.</li>
	*<li> Test Case Name: Actions on activity of a .docx file at home page.</li>
	*<li> Pre-Condition: 
	*A. Upload .doc file from your local machine with some pages or "doc-sample.doc" in .doc folder (Attachments tab)
	...
	*/
	@Test
	public  void test01_ActionsOnActivityOfA_docxFileAtHomePage() {
		info("Test 1: Actions on activity of a .docx file at home page");
		
		String fileName="docx-example-1.docx";
		...
		*Expected Outcome: 
			An activity for this .docx file is shown with:
		...
		waitForAndGetElement(hp.ELEMENT_FILE_SIZE.replace("@{fileName}",fileName).replace("${size}", "29"),2000,1);
		info("Verify actions");
	...
	/**
	*<li> Case ID:119934.</li>
	*<li> Test Case Name: Download a .docx file.</li>
	*<li> Pre-Condition: 
	*A. a .docx file exists in SEB. 
	...
	*/
	@Test(groups="pending")
	public  void test03_DownloadA_docxFile()  {
		info("Test 3: Download a .docx file");
		String fileName="docx-example-3.docx";
		...
		checkFileExisted(fileName);
		/*Step Number: 1
		*Step Name: Open .docx file
		*Step Description: 
			- Click title of .docx file
		*Input Data: 
			
		*Expected Outcome: 
			Content of .docx file is well displayed.*/
		...
		*Expected Outcome: 
			.docx file is saved successfully with right format and possible to open by office in local machine*/ 
		info("Clear data");
	...
	/**
	*<li> Case ID:119933.</li>
	*<li> Test Case Name: Edit a .docx file via webdav.</li>
	*<li> Pre-Condition: A.Upload .docx file from your local machine with some pages orin .docx folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	...
	*/
	@Test(groups="pending")
	public  void test05_EditA_docxFileViaWebdav() {
		info("Test 5: Edit a .docx file via webdav");
		/*Step Number: 1
		*Step Name: Step 1: Edit the file via webdav
		*Step Description: 
			- Go to folder which has .docx file
	...
	/**
	*<li> Case ID:119932.</li>
	*<li> Test Case Name: Remote edition of a .docx file.</li>
	*<li> Pre-Condition: A. Upload .docx file from your local machine with some pages or "docx
	-sample.docx" in .docx folder (Attachments tab)B. 
	...
	*/
	@Test(groups="pending")
	public  void test06_RemoteEditionOfA_docxFile() {
		info("Test 6: Remote edition of a .docx file");
		String fileName="test02_uploadfile.docx";
		...
		*Expected Outcome: 
		...
		cTemplate.goToNode(fileName);
		/*Step number: 2
		*Step Name: Edit .docx file
		*Step Description: 
			- Right click on .docx file then select [Download and allow Edition]
			- Select [Open]
		*Input Data: 
		...
		*Step Description: 
			- Edit content of this .docx file directly
			- Save
		*Input Data: 
	...
	/**
	*<li> Case ID:119935.</li>
	*<li> Test Case Name: Save a .docx file as PDF file.</li>
	*<li> Pre-Condition: 
	*A. Upload .docx file from your local machine with some pages or "docx
	-sample.docx" in .docx folder(Attachments tab)
	...
	*/
	@Test(groups="pending")
	public  void test07_SaveA_docxFileAsPDFFile() {
		info("Test 7: Save a .docx file as PDF file");
		String fileName="docx-example-4.docx";
	...
	/**
	*<li> Case ID:119937.</li>
	*<li> Test Case Name: Search a .docx file (based on keyword).</li>
	*<li> Pre-Condition: - Upload .docx file from your local machine with some pages or "docx
	-sample.docx" in .docx folder (Attachments tab)</li>
	*<li> Post-Condition: </li>
	*<li> Done with OSs and browsers : </li>
	*<li> Generated by rosso at 2015/04/06 09:43:17</li>
	*/
	@Test
	public  void test08_SearchA_docxFile_basedOnKeyword_() {
		info("Test 8: Search a .docx file (based on keyword)");
		String fileName="docx-example-4.docx";
		String searchName="docx-example";
		...
		*Step Description: 
			...
			- Input keyword(s) issued from docx
			-sample.docx in order to search for this file (words of the document, title..etc)
			- Type enter
		*Input Data: 
			
		*Expected Outcome: 
			The file docx-sample.docx is found and listed in the results*/
	...
	/**
	*<li> Case ID:119938.</li>
	*<li> Test Case Name: Upload a .docx file from action bar.</li>
	*<li> Pre-Condition: Take .docx file from your local machine with some pages or "docx
	-sample.docx" in .docx folder(Attachments tab)</li>
	PENDING: THIS CASE IS CHECKED IN PREVIOUS CASES. THE CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test09_UploadA_docxFileFromActionBar() {
		info("Test 9: Upload a .docx file from action bar");
		String fileName="docx-example-3.docx";
	...
	/**
	*<li> Case ID:119940.</li>
	*<li> Test Case Name: Upload a .docx file via WEBDAV.</li>
	*<li> Pre-Condition: A. Take all .docx files from your local machine with some pages orin .docx folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	- Click on File folder and press Ctrl+L
	- Paste the link: dav://[YOUR
	-IP
	-ADDRESS
	...
	*/
	@Test(groups="pending")
	public  void test10_UploadA_docxFileViaWEBDAV() {
		info("Test 10 Upload a .docx file via WEBDAV");
		/*Step Number: 1
		*Step Name: Upload .docx file
		*Step Description: 
			- Copy a .docx file toWEBDAV
		*Input Data: 
	...
	/**
	*<li> Case ID:119941.</li>
	*<li> Test Case Name: Upload a .docx file when drap and drop from local machine.</li>
	*<li> Pre-Condition: A. Take all .docx files from your local machine with some pages or "docx
	-sample.docx" in .docx folder (Attachments tab)B. Repeat steps for small and big files</li>
	*Pending : impossible to drag and drop from local machine
	*/
	@Test(groups="pending")
	public  void test11_UploadA_docxFileWhenDrapAndDropFromLocalMachine() {
		info("Test 11 Upload a .docx file when drap and drop from local machine");
		/*Step Number: 1
		*Step Name: Upload .docx file
		*Step Description: 
			- Log in
			...
			- Choose a driveOr
			- Go to Intranet/Documents
			- Drag & Drop a .docx file from local machine to Site Explorer
		*Input Data: 
	...
	/**
	*<li> Case ID:119939.</li>
	*<li> Test Case Name: Upload a .docx file when Right click on main pane.</li>
	*<li> Pre-Condition: Take .docx file from your local machine with some pages or "docx
	-sample.docx" in Functional > ECMS > Sites explorer > Office Test (Attachments tab)</li>
	*/
	@Test
	public  void test12_UploadA_docxFileWhenRightClickOnMainPane() {
		info("Test 12 Upload a .docx file when Right click on main pane");
		String fileName="docx-example-5.docx";
	...
	/**
	*<li> Case ID:119942.</li>
	*<li> Test Case Name: View a .docx file in Site Explorer.</li>
	*<li> Pre-Condition: A. Take .docx file from your local machine with some pages or "docx
	-sample.docx" in .docx folder (Attachments tab)B. Edit "exo.preoperties" file:1. Redirect to the directory: $PLATFORM_TOMCAT_HOME/gatein/conf/exo.properties (in Tomcat) or $PLATFORM_JBOSS_HOME/standalone/configuration/gatein/exo.properties (in Jboss)2. Find "JOD Converter (Documents preview)" section and delete "#" marks on the start of lines as:+exo.jodconverter.enable=false+exo.jodconverter.portnumbers=2002+exo.jodconverter.officehome=/usr/lib/libreoffice+exo.jodconverter.taskqueuetimeout=30000+exo.jodconverter.taskexecutiontimeout=120000+exo.jodconverter.maxtasksperprocess=200+exo.jodconverter.retrytimeout=1200003. After deleted all "#" marks of above lines, find "exo.jodconverter.enable" parameter and change "fasle" to "true" value.4. Find "exo.jodconverter.officehome" parameter. If on your computer installed libreoffice, keep this value. But if on your computer installed openoffice 4, change the value from "/usr/lib/libreoffice" to "/opt/openoffice4" on linux or "c:programfilesx86Openoffice4" on Windows or "c:programfilesx86Libreoffice4" on Windows5. Restart server</li>
	PENDING: THIS CASE IS CHECKED IN DOCUMENT PREVIEW AND OPEN IN OFFICE. SO, THIS CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test13_ViewA_docxFileInSiteExplorer() {
		info("Test 13 View a .docx file in Site Explorer");
		String fileName="docx-example-4.docx";
		...
		*Step Description: 
			- Log in
			- Go to Aministration/Content/ Sites Explorer
			- Upload a .docx file to Site Explorer
		*Input Data: 
		...
		*Expected Outcome: 
			Content of .docx file is well displayed with
			- File Name
			- Download icon
			- A toolbar with + paginator,+ zoom icon and preview ratio, + Rotate left & right icon+ View info icon +Save as PDF file*/ 
		info("Clear data");
	...
	/**
	*<li> Case ID:119936.</li>
	*<li> Test Case Name: Delete a .docx file.</li>
	*/
	@Test
	public  void test02_Delete_Docxfile() {
		info("Test 2: Delete a .docx file");
		String fileName="docx-example-2.docx";
		info("Pre conditions");
		navToolBar.goToSiteExplorer();
		ecms.uploadFile("TestData/"+fileName);
	...
	/**
	*<li> Case ID:119931.</li>
	*<li> Test Case Name: Edit a .docx file.</li>
	*
	*/
	@Test
	public void test04_Edit_Docxfile(){
		info("Test 4: Edit a .docx file");
		String fileName="docx-example-3.docx";
