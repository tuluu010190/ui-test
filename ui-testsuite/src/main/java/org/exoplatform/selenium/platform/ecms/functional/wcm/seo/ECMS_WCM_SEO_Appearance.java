...
public class ECMS_WCM_SEO_Appearance extends EcmsBase {
	 ...
	 * check color of SEO icon default is red on acme/news page
	 */
	@Test
	public void test01_CheckDefaulColorOfSEOWhenMetadataNotExit(){
		
		//check color of SEO icon default is red
	...
	public void test04_CheckColorOfSEOWhenOpenAnAdminPage(){
		...
		//check can not open SEO management
		goToSeoManagement();
	...
	public void test05_CheckSEOManagementWhenOpenPortalPage(){
		...
		info("SEO management form of overview page display true");		
	}
	
	/*case06: Screen of SEO management when user open a content page 
	...
	public void test06_CheckSEOManagementWhenOpenContentPage(){
		...
		info("SEO management form of News page display true");	
	}
}
