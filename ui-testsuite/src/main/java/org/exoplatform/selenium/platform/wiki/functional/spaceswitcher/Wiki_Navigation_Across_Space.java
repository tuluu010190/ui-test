...
public class Wiki_Navigation_Across_Space extends BasicAction {
	...
	public  void test02_ChangingWikiShouldDisplayTheRootPageOfTheTargetedWiki() {
		...
		waitForAndGetElement(ELEMENT_CHECK_WIKI_PAGE_PERSONAL.replace("${name}", PAGE_NAME1));
		waitForAndGetElement(ELEMENT_CHECK_WIKI_PAGE_PERSONAL.replace("${name}", PAGE_NAME2));
		waitForElementNotPresent(ELEMENT_CHECK_WIKI_PAGE_PERSONAL.replace("${name}", PAGE_SUB1));
		click(ELEMENT_CHECK_WIKI_PAGE_PERSONAL.replace("${name}", PAGE_NAME2));
		waitForAndGetElement(ELEMENT_CHECK_WIKI_PAGE_PERSONAL.replace("${name}", PAGE_SUB1));
		//waitForAndGetElement(ELEMENT_TITLE_WIKI_HOME);
	...
	public  void test04_SwitchingToIntranetFromASpaceWikiShouldNotDisplaySpaceNavigationAnymore() {
		...
		waitForAndGetElement(ELEMENT_SPACE_NAVIGATION_NAME.replace("${spaceName}", space1));
		click(ELEMENT_SPACE_SWITCHER_BREADCRUMB);
		click(ELEMENT_CREATE_WIKI_PERSONAL.replace("${name}", name));
		waitForAndGetElement(ELEMENT_CURRENT_SPACE_SWITCHER_SELECT.replace("${name}", name));
		waitForElementNotPresent(ELEMENT_SPACE_NAVIGATION_NAME.replace("${spaceName}", space1));
