...
import org.testng.annotations.*;
	...
	*
	*/
	public class OfficeTest_rtf extends PlatformBase{
	...
	/**
	*<li> Case ID:119288.</li>
	*<li> Test Case Name: Actions on activity of a .rtf file at home page.</li>
	*<li> Pre-Condition: 
	*A. Upload .rtfx file from your local machine with some pages or "rtf-sample.rtf" in .rtf folder (Attachments tab)
	...
	*/
	@Test
	public  void test01_ActionsOnActivityOfA_rtfFileAtHomePage() {
		info("Test 1: Actions on activity of a .rtf file at home page");
		
		String fileName="rtf-example.rtf";
		...
		*Expected Outcome: 
			An activity for this .rtf file is shown with:
		...
		waitForAndGetElement(hp.ELEMENT_FILE_SIZE.replace("@{fileName}",fileName).replace("${size}", "1"),2000,1);
		info("Verify actions");
	...
	/**
	*<li> Case ID:120003.</li>
	*<li> Test Case Name: Download a .rtf file.</li>
	*<li> Pre-Condition: 
	*A. a .rtf file exists in SEB. 
	...
	*/
	@Test(groups="pending")
	public  void test03_DownloadA_rtfFile()  {
		info("Test 3: Download a .rtf file");
		String fileName="rtf-example-2.rtf";
		...
		checkFileExisted(fileName);
		/*Step Number: 1
		*Step Name: Open .rtf file
		*Step Description: 
			- Click title of .rtf file
		*Input Data: 
			
		*Expected Outcome: 
			Content of .rtf file is well displayed.*/
		...
		*Expected Outcome: 
			.rtf file is saved successfully with right format and possible to open by office in local machine*/ 
		info("Clear data");
	...
	/**
	*<li> Case ID:120013.</li>
	*<li> Test Case Name: Edit a .rtf file via webdav.</li>
	*<li> Pre-Condition: A.Upload .rtf file from your local machine with some pages orin 
	*.rtf folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	...
	*/
	@Test(groups="pending")
	public  void test05_EditA_rtfFileViaWebdav() {
		info("Test 5: Edit a .rtf file via webdav");
		/*Step Number: 1
		*Step Name: Step 1: Edit the file via webdav
		*Step Description: 
			- Go to folder which has .rtf file
	...
	/**
	*<li> Case ID:120012.</li>
	*<li> Test Case Name: Remote edition of a .rtf file.</li>
	*<li> Pre-Condition: A. Upload .rtf file from your local machine with some pages 
	*or "rtf-sample.rtf" in .rtf folder (Attachments tab)B. 
	...
	*/
	@Test(groups="pending")
	public  void test06_RemoteEditionOfA_rtfFile() {
		info("Test 6: Remote edition of a .rtf file");
		String fileName="rtf-example-4.rtf";
		...
		*Expected Outcome: 
		...
		cTemplate.goToNode(fileName);
		/*Step number: 2
		*Step Name: Edit .rtf file
		*Step Description: 
			- Right click on .rtf file then select [Download and allow Edition]
			- Select [Open]
		*Input Data: 
	...
	/**
	*<li> Case ID:120004.</li>
	*<li> Test Case Name: Save a .rtf file as PDF file.</li>
	*<li> Pre-Condition: 
	*A. Upload .rtf file from your local machine with some pages or "rtf
	-sample.rtf" in .rtf folder(Attachments tab)
	...
	*/
	@Test(groups="pending")
	public  void test07_SaveA_rtfFileAsPDFFile() {
		info("Test 7: Save a .rtf file as PDF file");
		String fileName="rtf-example-4.rtf";
	...
	/**
	*<li> Case ID:120006.</li>
	*<li> Test Case Name: Search a .rtf file (based on keyword).</li>
	*<li> Pre-Condition: - Upload .rtf file from your local machine with some pages or "rtf
	-sample.rtf" in .rtf folder (Attachments tab)</li>
	*<li> Post-Condition: </li>
	*<li> Done with OSs and browsers : </li>
	*/
	@Test
	public  void test08_SearchA_rtfFile_basedOnKeyword_() {
		info("Test 8: Search a .rtf file (based on keyword)");
		String fileName="rtf-example-3.rtf";
		String searchName="rtf-example";
		...
		*Step Description: 
			...
			- Input keyword(s) issued from rtf
			-sample.rtf in order to search for this file (words of the document, title..etc)
			- Type enter
		*Input Data: 
			
		*Expected Outcome: 
			The file rtf
			-sample.rtf is found and listed in the results*/
	...
	/**
	*<li> Case ID:120009.</li>
	*<li> Test Case Name: Upload a .rtf file from action bar.</li>
	*<li> Pre-Condition: Take .rtf file from your local machine with some pages or "rtf
	-sample.rtf" in .rtf folder(Attachments tab)</li>
	PENDING: THIS CASE IS CHECKED IN PREVIOUS CASES. THE CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test09_UploadA_rtfFileFromActionBar() {
		info("Test 9: Upload a .rtf file from action bar");
		String fileName="rtf-example-3.rtf";
	...
	/**
	*<li> Case ID:120009.</li>
	*<li> Test Case Name: Upload a .rtf file via WEBDAV.</li>
	*<li> Pre-Condition: A. Take all .rtf files from your local machine with some pages orin .rtf folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	- Click on File folder and press Ctrl+L
	- Paste the link: dav://[YOUR
	-IP
	-ADDRESS
	...
	*/
	@Test(groups="pending")
	public  void test10_UploadA_rtfFileViaWEBDAV() {
		info("Test 10 Upload a .rtf file via WEBDAV");
		/*Step Number: 1
		*Step Name: Upload .rtf file
		*Step Description: 
			- Copy a .rtf file toWEBDAV
		*Input Data: 
	...
	/**
	*<li> Case ID:120010.</li>
	*<li> Test Case Name: Upload a .rtf file when drap and drop from local machine.</li>
	*<li> Pre-Condition: A. Take all .rtf files from your local machine with some pages or 
	*"rtf-sample.rtf" in .rtf folder (Attachments tab)B. Repeat steps for small and big files</li>
	*Pending : impossible to drag and drop from local machine
	*/
	@Test(groups="pending")
	public  void test11_UploadA_rtfFileWhenDrapAndDropFromLocalMachine() {
		info("Test 11 Upload a .rtf file when drap and drop from local machine");
		/*Step Number: 1
		*Step Name: Upload .rtf file
		*Step Description: 
			- Log in
			...
			- Choose a driveOr
			- Go to Intranet/Documents
			- Drag & Drop a .rtf file from local machine to Site Explorer
		*Input Data: 
	...
	/**
	*<li> Case ID:120008.</li>
	*<li> Test Case Name: Upload a .rtf file when Right click on main pane.</li>
	*<li> Pre-Condition: Take .rtf file from your local machine with some pages or 
	*"rtf-sample.rtf" in Functional > ECMS > Sites explorer > Office Test (Attachments tab)</li>
	*/
	@Test
	public  void test12_UploadA_rtfFileWhenRightClickOnMainPane() {
		info("Test 12 Upload a .rtf file when Right click on main pane");
		String fileName="rtf-example-4.rtf";
	...
	/**
	*<li> Case ID:120014.</li>
	*<li> Test Case Name: View a .rtf file in Site Explorer.</li>
	*<li> Pre-Condition: A. Take .rtf file from your local machine with some pages or "rtf
	-sample.rtf" in .rtf folder (Attachments tab)B. Edit "exo.preoperties" file:1. Redirect to the directory: $PLATFORM_TOMCAT_HOME/gatein/conf/exo.properties (in Tomcat) or $PLATFORM_JBOSS_HOME/standalone/configuration/gatein/exo.properties (in Jboss)2. Find "JOD Converter (Documents preview)" section and delete "#" marks on the start of lines as:+exo.jodconverter.enable=false+exo.jodconverter.portnumbers=2002+exo.jodconverter.officehome=/usr/lib/libreoffice+exo.jodconverter.taskqueuetimeout=30000+exo.jodconverter.taskexecutiontimeout=120000+exo.jodconverter.maxtasksperprocess=200+exo.jodconverter.retrytimeout=1200003. After deleted all "#" marks of above lines, find "exo.jodconverter.enable" parameter and change "fasle" to "true" value.4. Find "exo.jodconverter.officehome" parameter. If on your computer installed libreoffice, keep this value. But if on your computer installed openoffice 4, change the value from "/usr/lib/libreoffice" to "/opt/openoffice4" on linux or "c:programfilesx86Openoffice4" on Windows or "c:programfilesx86Libreoffice4" on Windows5. Restart server</li>
	PENDING: THIS CASE IS CHECKED IN DOCUMENT PREVIEW AND OPEN IN OFFICE. SO, THIS CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test13_ViewA_rtfFileInSiteExplorer() {
		info("Test 13 View a .rtf file in Site Explorer");
		String fileName="rtf-example-4.rtf";
		...
		*Step Description: 
			- Log in
			- Go to Aministration/Content/ Sites Explorer
			- Upload a .rtf file to Site Explorer
		*Input Data: 
		...
		*Expected Outcome: 
			Content of .rtf file is well displayed with
			- File Name
			- Download icon
			- A toolbar with + paginator,+ zoom icon and preview ratio, + Rotate left & right icon+ View info icon +Save as PDF file*/ 
		info("Clear data");
	...
	/**
	*<li> Case ID:120005.</li>
	*<li> Test Case Name: Delete a .rtf file.</li>
	*/
	@Test
	public  void test02_Delete_rtffile() {
		info("Test 2: Delete a .rtf file");
		String fileName="rtf-example-1.rtf";
		info("Pre conditions");
		navToolBar.goToSiteExplorer();
		ecms.uploadFile("TestData/"+fileName);
	...
	/**
	*<li> Case ID:120011.</li>
	*<li> Test Case Name: Edit a .rtf file.</li>
	*
	*/
	@Test
	public void test04_Edit_rtffile(){
		info("Test 4: Edit a .rtf file");
		String fileName="rtf-example-2.rtf";
