...
import org.testng.annotations.*;
	...
	*
	*/
	public class OfficeTest_ppt extends PlatformBase{
	...
	/**
	*<li> Case ID:119286.</li>
	*<li> Test Case Name: Actions on activity of a .ppt file at home page.</li>
	*<li> Pre-Condition: 
	*A. Upload .ppt file from your local machine with some pages or "ppt-sample.ppt" in .ppt folder (Attachments tab)
	...
	*/
	@Test
	public  void test01_ActionsOnActivityOfA_pptFileAtHomePage() {
		info("Test 1: Actions on activity of a .ppt file at home page");
		
		String fileName="ppt-example.ppt";
		...
		*Expected Outcome: 
			An activity for this .ppt file is shown with:
		...
		waitForAndGetElement(hp.ELEMENT_FILE_SIZE.replace("@{fileName}",fileName).replace("${size}", "587"),2000,1);
		info("Verify actions");
	...
	/**
	*<li> Case ID:119979.</li>
	*<li> Test Case Name: Download a .ppt file.</li>
	*<li> Pre-Condition: 
	*A. a .ppt file exists in SEB. 
	...
	*/
	@Test(groups="pending")
	public  void test03_DownloadA_pptFile()  {
		info("Test 3: Download a .ppt file");
		String fileName="ppt-example-2.ppt";
		...
		checkFileExisted(fileName);
		/*Step Number: 1
		*Step Name: Open .ppt file
		*Step Description: 
			- Click title of .ppt file
		*Input Data: 
			
		*Expected Outcome: 
			Content of .ppt file is well displayed.*/
		...
		*Expected Outcome: 
			.ppt file is saved successfully with right format and possible to open by office in local machine*/ 
		info("Clear data");
	...
	/**
	*<li> Case ID:119985.</li>
	*<li> Test Case Name: Edit a .ppt file via webdav.</li>
	*<li> Pre-Condition: A.Upload .ppt file from your local machine with some pages orin 
	*.ppt folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	...
	*/
	@Test(groups="pending")
	public  void test05_EditA_pptFileViaWebdav() {
		info("Test 5: Edit a .ppt file via webdav");
		/*Step Number: 1
		*Step Name: Step 1: Edit the file via webdav
		*Step Description: 
			- Go to folder which has .ppt file
	...
	/**
	*<li> Case ID:119984.</li>
	*<li> Test Case Name: Remote edition of a .ppt file.</li>
	*<li> Pre-Condition: A. Upload .ppt file from your local machine with some pages 
	*or "ppt-sample.ppt" in .ppt folder (Attachments tab)B. 
	...
	*/
	@Test(groups="pending")
	public  void test06_RemoteEditionOfA_pptFile() {
		info("Test 6: Remote edition of a .ppt file");
		String fileName="ppt-example-4.ppt";
		...
		*Expected Outcome: 
		...
		cTemplate.goToNode(fileName);
		/*Step number: 2
		*Step Name: Edit .ppt file
		*Step Description: 
			- Right click on .ppt file then select [Download and allow Edition]
			- Select [Open]
		*Input Data: 
	...
	/**
	*<li> Case ID:119980.</li>
	*<li> Test Case Name: Save a .ppt file as PDF file.</li>
	*<li> Pre-Condition: 
	*A. Upload .ppt file from your local machine with some pages or "ppt
	-sample.ppt" in .ppt folder(Attachments tab)
	...
	*/
	@Test(groups="pending")
	public  void test07_SaveA_pptFileAsPDFFile() {
		info("Test 7: Save a .ppt file as PDF file");
		String fileName="ppt-example-4.ppt";
	...
	/**
	*<li> Case ID:119982.</li>
	*<li> Test Case Name: Search a .ppt file (based on keyword).</li>
	*<li> Pre-Condition: - Upload .ppt file from your local machine with some pages or "ppt
	-sample.ppt" in .ppt folder (Attachments tab)</li>
	*<li> Post-Condition: </li>
	*<li> Done with OSs and browsers : </li>
	*/
	@Test
	public  void test08_SearchA_pptFile_basedOnKeyword_() {
		info("Test 8: Search a .ppt file (based on keyword)");
		String fileName="ppt-example-3.ppt";
		String searchName="ppt-example";
		...
		*Step Description: 
			...
			- Input keyword(s) issued from ppt
			-sample.ppt in order to search for this file (words of the document, title..etc)
			- Type enter
		*Input Data: 
			
		*Expected Outcome: 
			The file ppt
			-sample.ppt is found and listed in the results*/
	...
	/**
	*<li> Case ID:119986.</li>
	*<li> Test Case Name: Upload a .ppt file from action bar.</li>
	*<li> Pre-Condition: Take .ppt file from your local machine with some pages or "ppt
	-sample.ppt" in .ppt folder(Attachments tab)</li>
	PENDING: THIS CASE IS CHECKED IN PREVIOUS CASES. THE CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test09_UploadA_pptFileFromActionBar() {
		info("Test 9: Upload a .ppt file from action bar");
		String fileName="ppt-example-3.ppt";
	...
	/**
	*<li> Case ID:119988.</li>
	*<li> Test Case Name: Upload a .ppt file via WEBDAV.</li>
	*<li> Pre-Condition: A. Take all .ppt files from your local machine with some pages orin .ppt folder (Attachments tab)B. Mount a WebDAV Drive with a random folder1.Connect to server at your computer a. On Linux: 
	- Click on File folder and press Ctrl+L
	- Paste the link: dav://[YOUR
	-IP
	-ADDRESS
	...
	*/
	@Test(groups="pending")
	public  void test10_UploadA_pptFileViaWEBDAV() {
		info("Test 10 Upload a .ppt file via WEBDAV");
		/*Step Number: 1
		*Step Name: Upload .ppt file
		*Step Description: 
			- Copy a .ppt file toWEBDAV
		*Input Data: 
	...
	/**
	*<li> Case ID:119989.</li>
	*<li> Test Case Name: Upload a .ppt file when drap and drop from local machine.</li>
	*<li> Pre-Condition: A. Take all .ppt files from your local machine with some pages or 
	*"ppt-sample.ppt" in .ppt folder (Attachments tab)B. Repeat steps for small and big files</li>
	*Pending : impossible to drag and drop from local machine
	*/
	@Test(groups="pending")
	public  void test11_UploadA_pptFileWhenDrapAndDropFromLocalMachine() {
		info("Test 11 Upload a .ppt file when drap and drop from local machine");
		/*Step Number: 1
		*Step Name: Upload .ppt file
		*Step Description: 
			- Log in
			...
			- Choose a driveOr
			- Go to Intranet/Documents
			- Drag & Drop a .ppt file from local machine to Site Explorer
		*Input Data: 
	...
	/**
	*<li> Case ID:119987.</li>
	*<li> Test Case Name: Upload a .ppt file when Right click on main pane.</li>
	*<li> Pre-Condition: Take .ppt file from your local machine with some pages or 
	*"ppt-sample.ppt" in Functional > ECMS > Sites explorer > Office Test (Attachments tab)</li>
	*/
	@Test
	public  void test12_UploadA_pptFileWhenRightClickOnMainPane() {
		info("Test 12 Upload a .ppt file when Right click on main pane");
		String fileName="ppt-example-4.ppt";
	...
	/**
	*<li> Case ID:119990.</li>
	*<li> Test Case Name: View a .ppt file in Site Explorer.</li>
	*<li> Pre-Condition: A. Take .ppt file from your local machine with some pages or "ppt
	-sample.ppt" in .ppt folder (Attachments tab)B. Edit "exo.preoperties" file:1. Redirect to the directory: $PLATFORM_TOMCAT_HOME/gatein/conf/exo.properties (in Tomcat) or $PLATFORM_JBOSS_HOME/standalone/configuration/gatein/exo.properties (in Jboss)2. Find "JOD Converter (Documents preview)" section and delete "#" marks on the start of lines as:+exo.jodconverter.enable=false+exo.jodconverter.portnumbers=2002+exo.jodconverter.officehome=/usr/lib/libreoffice+exo.jodconverter.taskqueuetimeout=30000+exo.jodconverter.taskexecutiontimeout=120000+exo.jodconverter.maxtasksperprocess=200+exo.jodconverter.retrytimeout=1200003. After deleted all "#" marks of above lines, find "exo.jodconverter.enable" parameter and change "fasle" to "true" value.4. Find "exo.jodconverter.officehome" parameter. If on your computer installed libreoffice, keep this value. But if on your computer installed openoffice 4, change the value from "/usr/lib/libreoffice" to "/opt/openoffice4" on linux or "c:programfilesx86Openoffice4" on Windows or "c:programfilesx86Libreoffice4" on Windows5. Restart server</li>
	PENDING: THIS CASE IS CHECKED IN DOCUMENT PREVIEW AND OPEN IN OFFICE. SO, THIS CASE IS REMOVED
	*/
	@Test(groups="pending")
	public  void test13_ViewA_pptFileInSiteExplorer() {
		info("Test 13 View a .ppt file in Site Explorer");
		String fileName="ppt-example-4.ppt";
		...
		*Step Description: 
			- Log in
			- Go to Aministration/Content/ Sites Explorer
			- Upload a .ppt file to Site Explorer
		*Input Data: 
		...
		*Expected Outcome: 
			Content of .ppt file is well displayed with
			- File Name
			- Download icon
			- A toolbar with + paginator,+ zoom icon and preview ratio, + Rotate left & right icon+ View info icon +Save as PDF file*/ 
		info("Clear data");
	...
	/**
	*<li> Case ID:119981.</li>
	*<li> Test Case Name: Delete a .ppt file.</li>
	*/
	@Test
	public  void test02_Delete_pptfile() {
		info("Test 2: Delete a .ppt file");
		String fileName="ppt-example-1.ppt";
		info("Pre conditions");
		navToolBar.goToSiteExplorer();
		ecms.uploadFile("TestData/"+fileName);
	...
	/**
	*<li> Case ID:119983.</li>
	*<li> Test Case Name: Edit a .ppt file.</li>
	*
	*/
	@Test
	public void test04_Edit_pptfile(){
		info("Test 4: Edit a .ppt file");
		String fileName="ppt-example-2.ppt";
