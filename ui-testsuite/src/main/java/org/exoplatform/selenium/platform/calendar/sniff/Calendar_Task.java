...
public class Calendar_Task extends CalendarBase {
	...
	public void test01_AddNewTask() {
		...
		waitForAndGetElement(By.xpath(tsk.ELEMENT_ALL_DAY_TASK.replace("${taskTitle}", CALENDAR01)));
	...
	public void test02_CheckPopupReminderOfTask() {
		...
		info("Restore data");
		waitForAndGetElement(By.xpath(tsk.ELEMENT_ALL_DAY_TASK.replace("${taskTitle}", CALENDAR02)));
	...
	public void test03_CheckEmailReminderOfTask() {
		...
		info("Restore data");
		waitForAndGetElement(By.xpath(tsk.ELEMENT_ALL_DAY_TASK.replace("${taskTitle}", CALENDAR03)));
	...
	public void test04_EditTask(){
		...
		info("Edit a task");
		tsk.editTask(CALENDAR04,TITLE,DESCRIPTION);
		
		info("Restore data");
		waitForAndGetElement(By.xpath(tsk.ELEMENT_ALL_DAY_TASK.replace("${taskTitle}", CALENDAR04)));
	...
	public void test06_DragDropTask(){
		...
		waitForAndGetElement(By.xpath(tsk.ELEMENT_CURRENT_TASK.replace("${taskName}", CALENDAR06)));
		dragAndDropToObject(By.xpath(tsk.ELEMENT_CURRENT_TASK.replace("${taskName}", CALENDAR06)),ELEMENT_TARGET_DATE);
	...
	public void test07_ResizeTask(){
		...
		waitForAndGetElement(By.xpath(tsk.ELEMENT_ALL_DAY_TASK.replace("${taskTitle}", CALENDAR07)));
