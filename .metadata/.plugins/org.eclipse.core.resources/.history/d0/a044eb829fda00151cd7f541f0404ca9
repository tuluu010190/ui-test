...
public class TaskManagementLocatorObject extends PlatformBase {
	...
	public final String ELEMENT_LEFT_PANEL_PROJECT_NAME=".//*[contains(@class,'project-name')][contains(.,'$project')]";
	...
	public final String ELEMENT_ADD_PROJECT_PARENT_PROJECT_DROP_MENU=".//*[contains(@class,'uiDropdownMenu')]//*[contains(text(),'$project')]";
	public final By ELEMENT_ADD_PROJECT_TITLE=By.xpath(".//*[contains(@class,'addProject')]//*[contains(@name,'name')]");
    public final By ELEMENT_ADD_PROJECT_DES=By.xpath(".//*[contains(@class,'addProject')]//*[contains(@name,'description')]");
    public final By ELEMETN_ADD_PROJECT_ENABLE_CALENDAR_CHECKBOX=By.xpath(".//*[contains(@class,'addProject')]//*[contains(@class,'checkbox')]");
